...
type Metadata struct {
	...
	// GenerateConfig controls which config artifacts are generated.
...
// GenerateConfig controls which config artifacts are generated by mdatagen.
...
// ShouldGenerateSchema returns true if JSON schema file generation is enabled.
func (g GenerateConfig) ShouldGenerateSchema() bool {
	return g.Schema == nil || *g.Schema
}

// ShouldGenerateCode returns true if Go config generation is enabled.
func (g GenerateConfig) ShouldGenerateCode() bool {
	return g.Code == nil || *g.Code
}

// ShouldGenerateDocs returns true if README config docs generation is enabled.
func (g GenerateConfig) ShouldGenerateDocs() bool {
	return g.Docs == nil || *g.Docs
}
