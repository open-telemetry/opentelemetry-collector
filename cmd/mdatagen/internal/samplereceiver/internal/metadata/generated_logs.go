...
type eventOptionFunc func(plog.LogRecord)

func (eof eventOptionFunc) apply(lr plog.LogRecord) {
	eof(lr)
}

func WithEventTraceId(traceID pcommon.TraceID) EventOption {
	return eventOptionFunc(func(lr plog.LogRecord) {
		lr.SetTraceID(traceID)
	})
}

func WithEventSpanId(spanID pcommon.SpanID) EventOption {
	return eventOptionFunc(func(lr plog.LogRecord) {
		lr.SetSpanID(spanID)
	})
}
...
func (e *eventDefaultEvent) recordEvent(timestamp pcommon.Timestamp, stringAttrAttributeValue string, overriddenIntAttrAttributeValue int64, enumAttrAttributeValue string, sliceAttrAttributeValue []any, mapAttrAttributeValue map[string]any, options ...EventOption) {
	if !e.config.Enabled {
		return
	}
...
func (e *eventDefaultEventToBeRemoved) recordEvent(timestamp pcommon.Timestamp, stringAttrAttributeValue string, overriddenIntAttrAttributeValue int64, enumAttrAttributeValue string, sliceAttrAttributeValue []any, mapAttrAttributeValue map[string]any, options ...EventOption) {
	if !e.config.Enabled {
		return
	}
	lr := e.data.AppendEmpty()
...
func (e *eventDefaultEventToBeRenamed) recordEvent(timestamp pcommon.Timestamp, stringAttrAttributeValue string, booleanAttrAttributeValue bool, booleanAttr2AttributeValue bool, options ...EventOption) {
	if !e.config.Enabled {
		return
	}
	lr := e.data.AppendEmpty()
...
func (lb *LogsBuilder) RecordDefaultEventEvent(timestamp pcommon.Timestamp, stringAttrAttributeValue string, overriddenIntAttrAttributeValue int64, enumAttrAttributeValue AttributeEnumAttr, sliceAttrAttributeValue []any, mapAttrAttributeValue map[string]any, options ...EventOption) {
...
func (lb *LogsBuilder) RecordDefaultEventToBeRemovedEvent(timestamp pcommon.Timestamp, stringAttrAttributeValue string, overriddenIntAttrAttributeValue int64, enumAttrAttributeValue AttributeEnumAttr, sliceAttrAttributeValue []any, mapAttrAttributeValue map[string]any, options ...EventOption) {
...
func (lb *LogsBuilder) RecordDefaultEventToBeRenamedEvent(timestamp pcommon.Timestamp, stringAttrAttributeValue string, booleanAttrAttributeValue bool, booleanAttr2AttributeValue bool, options ...EventOption) {
