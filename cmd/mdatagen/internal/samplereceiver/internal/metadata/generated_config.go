...
func (rac *ResourceAttributesConfig) Validate() error {
	...
	if rac.StringResourceDisabledAttrToBeRemoved.OverrideValue != nil {
		val := pcommon.NewValueEmpty()
		if err := val.FromRaw(rac.StringResourceDisabledAttrToBeRemoved.OverrideValue); err != nil {
			return fmt.Errorf("override_value for string.resource.disabled_attr_to_be_removed: %w", err)
		}
		if val.Type() != pcommon.ValueTypeStr {
			return fmt.Errorf("override_value for string.resource.disabled_attr_to_be_removed must be a string, got %v", val.Type())
		}
		rac.StringResourceDisabledAttrToBeRemoved.overrideVal = val
		rac.StringResourceDisabledAttrToBeRemoved.overrideValSet = true
	}
	return nil
}
