	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			for i := 0; i < ms.Len(); i++ {
				switch ms.At(i).Name() {
				case "default.metric":
					assert.Falsef(t, validatedMetrics["default.metric"], "Found a duplicate in the metrics slice: default.metric")
				...
				case "default.metric.to_be_removed":
					assert.Falsef(t, validatedMetrics["default.metric.to_be_removed"], "Found a duplicate in the metrics slice: default.metric.to_be_removed")
				...
				case "metric.input_type":
					assert.Falsef(t, validatedMetrics["metric.input_type"], "Found a duplicate in the metrics slice: metric.input_type")
				...
				case "optional.metric":
					assert.Falsef(t, validatedMetrics["optional.metric"], "Found a duplicate in the metrics slice: optional.metric")
				...
				case "optional.metric.empty_unit":
					assert.Falsef(t, validatedMetrics["optional.metric.empty_unit"], "Found a duplicate in the metrics slice: optional.metric.empty_unit")
