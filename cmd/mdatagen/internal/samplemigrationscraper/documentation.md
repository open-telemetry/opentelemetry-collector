...
- Disable Old Gate: `scraper.sample.DontEmitV0SystemConventions`
- Enable New Gate: `scraper.sample.EmitV1SystemConventions`
...
| ------------ | ----- | ----------- | ------------ | ---------- | --------- |
| `scraper.sample.DontEmitV0SystemConventions` | alpha | When enabled, semconv legacy attributes are disabled. | v0.145.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/45592) |
| `scraper.sample.EmitV1SystemConventions` | alpha | When enabled, semconv stable attributes are enabled. | v0.145.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/45592) |
