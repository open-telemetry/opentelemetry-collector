...
func TestProviders(t *testing.T) {
	...
	if m, ok := meter.(mockMeter); ok {
		require.Equal(t, "go.opentelemetry.io/collector/cmd/mdatagen/internal/samplepkg", m.name)
	} else {
...
func TestNewTelemetryBuilder(t *testing.T) {
	...
	applied := false
	_, err := NewTelemetryBuilder(set, "test", telemetryBuilderOptionFunc(func(b *TelemetryBuilder) {
		applied = true
	}))
