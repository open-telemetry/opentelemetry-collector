...
require (
	...
	go.opentelemetry.io/collector/extension/remotetapextension v0.107.0
...
replace go.opentelemetry.io/collector/extension/remotetapextension => ../../extension/remotetapextension
