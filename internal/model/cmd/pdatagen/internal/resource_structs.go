...
package internal // import "go.opentelemetry.io/collector/internal/model/cmd/pdatagen/internal"

var resourceFile = &File{
	Name: "resource",
	imports: []string{
		`otlpresource "go.opentelemetry.io/collector/internal/model/data/protogen/resource/v1"`,
	},
	testImports: []string{
		`"testing"`,
		``,
