...
func (t *testReceiver) Start(_ context.Context, host component.Host) error {
	if statusReporter, ok := host.(componentstatus.Reporter); ok {
		...
		go func() {
			...
			statusReporter.Report(componentstatus.NewStatusEvent(componentstatus.StatusOK))
		}()
	}
	return nil
}
...
func (t *testExtension) Start(ctx context.Context, host component.Host) error {
	return nil
}

// Shutdown implements the component.Component interface.
func (t *testExtension) Shutdown(ctx context.Context) error {
	return nil
}
...
func (t *testExtension) NotifyConfig(ctx context.Context, conf *confmap.Conf) error {
	return nil
}
