...
require (
	...
	go.opentelemetry.io/collector/internal/sharedcomponent v0.145.0
...
replace go.opentelemetry.io/contrib/otelconf => github.com/codeboten/opentelemetry-go-contrib/otelconf v0.0.0-20260204000334-1156a1170299
