...
func NewTextTracesMarshaler() traces.Marshaler {
	return textTracesMarshaler{}
}

type textTracesMarshaler struct{}

// MarshalTraces traces.Traces to OTLP text.
func (textTracesMarshaler) MarshalTraces(td traces.Traces) ([]byte, error) {
	buf := dataBuffer{}
