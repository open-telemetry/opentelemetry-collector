...
type Span struct {
	...
	TraceId go_opentelemetry_io_collector_internal_data_opentelemetry_proto_gen_common_v1.TraceID `protobuf:"bytes,1,opt,name=trace_id,json=traceId,proto3,customtype=go.opentelemetry.io/collector/internal/data/opentelemetry-proto-gen/common/v1.TraceID" json:"trace_id"`
	...
	//
	// This field is required.
	SpanId go_opentelemetry_io_collector_internal_data_opentelemetry_proto_gen_common_v1.SpanID `protobuf:"bytes,2,opt,name=span_id,json=spanId,proto3,customtype=go.opentelemetry.io/collector/internal/data/opentelemetry-proto-gen/common/v1.SpanID" json:"span_id"`
	...
	ParentSpanId go_opentelemetry_io_collector_internal_data_opentelemetry_proto_gen_common_v1.SpanID `protobuf:"bytes,4,opt,name=parent_span_id,json=parentSpanId,proto3,customtype=go.opentelemetry.io/collector/internal/data/opentelemetry-proto-gen/common/v1.SpanID" json:"parent_span_id"`
...
var fileDescriptor_5c407ac9c675a601 = []byte{
	...
	,
}
