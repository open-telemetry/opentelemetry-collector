...
gensemconv: $(SEMCONVGEN) $(SEMCONVKIT)
	...
	$(SEMCONVGEN) -o semconv/${SPECTAG} -t semconv/template.j2 -s ${SPECTAG} -i ${SPECPATH}/model/. --only=attribute_group -p conventionType=trace -f generated_attribute_group.go
