...
BUILD_INFO_IMPORT_PATH=github.com/open-telemetry/opentelemtry-service/internal/version
...
test-with-cover:
	...
	@scripts/check-test-files.sh $(subst github.com/open-telemetry/opentelemtry-service/,./,$(ALL_PKGS))
