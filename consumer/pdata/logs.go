...
func LogsFromInternalRep(logs data.InternalLogsWrapper) Logs {
...
func (ld Logs) InternalRep() data.InternalLogsWrapper {
	return data.InternalLogsWrapper{Orig: ld.orig}
}
