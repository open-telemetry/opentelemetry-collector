...
type ExemplarSlice struct {
	parent internal.SliceParent[*[]otlpmetrics.Exemplar]
}
type stubExemplarSliceParent struct {
	orig *[]otlpmetrics.Exemplar
}

func (s stubExemplarSliceParent) GetChildOrig() *[]otlpmetrics.Exemplar {
	return s.orig
}

func (s stubExemplarSliceParent) EnsureMutability() {}

func (s stubExemplarSliceParent) GetState() *internal.State {
...
func newExemplarSliceFromParent(parent internal.SliceParent[*[]otlpmetrics.Exemplar]) ExemplarSlice {
...
func (es ExemplarSlice) CopyTo(dest ExemplarSlice) {
	...
	for i := range *es.getOrig() {
		...
		destExemplar := Exemplar{&pExemplar{orig: &(*dest.getOrig())[i],
			state: &exclState}}
