...
func newExponentialHistogramDataPointSliceFromElementOrig(elOrig *otlpmetrics.ExponentialHistogramDataPoint) ExponentialHistogramDataPointSlice {
	orig := []*otlpmetrics.ExponentialHistogramDataPoint{elOrig}
...
func (es ExponentialHistogramDataPointSlice) getChildOrig(i int) *otlpmetrics.ExponentialHistogramDataPoint {
	return (*es.getOrig())[i]
}
...
func (es ExponentialHistogramDataPointSlice) At(i int) ExponentialHistogramDataPoint {
	return newExponentialHistogramDataPointFromParent(es, i)
}
...
func (es ExponentialHistogramDataPointSlice) CopyTo(dest ExponentialHistogramDataPointSlice) {
	...
	if srcLen <= destCap {
		...
		for i := range *es.getOrig() {
			srcExponentialHistogramDataPoint := newExponentialHistogramDataPointFromOrig((*es.getOrig())[i])
			destExponentialHistogramDataPoint := newExponentialHistogramDataPointFromOrig((*dest.getOrig())[i])
	...
	for i := range *es.getOrig() {
		wrappers[i] = &origs[i]
		srcExponentialHistogramDataPoint := newExponentialHistogramDataPointFromOrig((*es.getOrig())[i])
		destExponentialHistogramDataPoint := newExponentialHistogramDataPointFromOrig(wrappers[i])
		srcExponentialHistogramDataPoint.CopyTo(destExponentialHistogramDataPoint)
	}
