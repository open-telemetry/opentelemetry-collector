...
func newExponentialHistogramDataPointSliceFromOrig(orig *[]*otlpmetrics.ExponentialHistogramDataPoint) ExponentialHistogramDataPointSlice {
	return ExponentialHistogramDataPointSlice{parent: newExponentialHistogramFromDataPointsOrig(orig)}
}

func newExponentialHistogramDataPointSliceFromParent(parent ExponentialHistogram) ExponentialHistogramDataPointSlice {
	return ExponentialHistogramDataPointSlice{parent: parent}
}
...
func NewExponentialHistogramDataPointSlice() ExponentialHistogramDataPointSlice {
	...
	return newExponentialHistogramDataPointSliceFromOrig(&orig)
}
...
func (es ExponentialHistogramDataPointSlice) CopyTo(dest ExponentialHistogramDataPointSlice) {
	...
	if srcLen <= destCap {
		...
		for i := range *es.getOrig() {
			...
			destExponentialHistogramDataPoint := ExponentialHistogramDataPoint{&pExponentialHistogramDataPoint{orig: (*dest.getOrig())[i],
				state: &exclState}}
