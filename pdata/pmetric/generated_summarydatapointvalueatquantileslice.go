...
func newSummaryDataPointValueAtQuantileSliceFromOrig(orig *[]*otlpmetrics.SummaryDataPoint_ValueAtQuantile) SummaryDataPointValueAtQuantileSlice {
	return SummaryDataPointValueAtQuantileSlice{parent: newSummaryDataPointFromQuantileValuesOrig(orig)}
}

func newSummaryDataPointValueAtQuantileSliceFromParent(parent SummaryDataPoint) SummaryDataPointValueAtQuantileSlice {
	return SummaryDataPointValueAtQuantileSlice{parent: parent}
}

func (es SummaryDataPointValueAtQuantileSlice) getOrig() *[]*otlpmetrics.SummaryDataPoint_ValueAtQuantile {
	return es.parent.getQuantileValuesOrig()
}
...
func NewSummaryDataPointValueAtQuantileSlice() SummaryDataPointValueAtQuantileSlice {
	...
	return newSummaryDataPointValueAtQuantileSliceFromOrig(&orig)
}
...
func (es SummaryDataPointValueAtQuantileSlice) CopyTo(dest SummaryDataPointValueAtQuantileSlice) {
	...
	if srcLen <= destCap {
		...
		for i := range *es.getOrig() {
			...
			destSummaryDataPointValueAtQuantile := SummaryDataPointValueAtQuantile{&pSummaryDataPointValueAtQuantile{orig: (*dest.getOrig())[i],
				state: &exclState}}
