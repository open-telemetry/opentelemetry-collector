...
func newSummaryDataPointValueAtQuantileSliceFromElementOrig(elOrig *otlpmetrics.SummaryDataPoint_ValueAtQuantile) SummaryDataPointValueAtQuantileSlice {
	orig := []*otlpmetrics.SummaryDataPoint_ValueAtQuantile{elOrig}
...
func (es SummaryDataPointValueAtQuantileSlice) getChildOrig(i int) *otlpmetrics.SummaryDataPoint_ValueAtQuantile {
	return (*es.getOrig())[i]
}
...
func (es SummaryDataPointValueAtQuantileSlice) At(i int) SummaryDataPointValueAtQuantile {
	return newSummaryDataPointValueAtQuantileFromParent(es, i)
}
...
func (es SummaryDataPointValueAtQuantileSlice) CopyTo(dest SummaryDataPointValueAtQuantileSlice) {
	...
	if srcLen <= destCap {
		...
		for i := range *es.getOrig() {
			srcSummaryDataPointValueAtQuantile := newSummaryDataPointValueAtQuantileFromOrig((*es.getOrig())[i])
			destSummaryDataPointValueAtQuantile := newSummaryDataPointValueAtQuantileFromOrig((*dest.getOrig())[i])
	...
	for i := range *es.getOrig() {
		wrappers[i] = &origs[i]
		srcSummaryDataPointValueAtQuantile := newSummaryDataPointValueAtQuantileFromOrig((*es.getOrig())[i])
		destSummaryDataPointValueAtQuantile := newSummaryDataPointValueAtQuantileFromOrig(wrappers[i])
		srcSummaryDataPointValueAtQuantile.CopyTo(destSummaryDataPointValueAtQuantile)
	}
