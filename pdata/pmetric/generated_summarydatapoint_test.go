...
func fillTestSummaryDataPoint(tv SummaryDataPoint) {
	internal.FillTestMap(internal.NewMap(&tv.getOrig().Attributes, wrappedSummaryDataPointAttributes{SummaryDataPoint: tv}))
	...
	fillTestSummaryDataPointValueAtQuantileSlice(newSummaryDataPointValueAtQuantileSlice(&tv.getOrig().QuantileValues, tv))
	tv.getOrig().Flags = 1
}
