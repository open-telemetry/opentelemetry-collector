...
func (es wrappedExponentialHistogramDataPointAttributes) RefreshOrigState() (*[]otlpcommon.KeyValue, *internal.State) {
...
func (es wrappedExponentialHistogramDataPointExemplars) RefreshOrigState() (*[]otlpmetrics.Exemplar, *internal.State) {
...
func (ms ExponentialHistogramDataPoint) Attributes() pcommon.Map {
	return pcommon.Map(internal.NewMap(&ms.getOrig().Attributes, wrappedExponentialHistogramDataPointAttributes{ExponentialHistogramDataPoint: ms}))
}
...
func (ms ExponentialHistogramDataPoint) Exemplars() ExemplarSlice {
	return ExemplarSlice(newExemplarSlice(&ms.getOrig().Exemplars, wrappedExponentialHistogramDataPointExemplars{ExponentialHistogramDataPoint: ms}))
}
