...
func fillTestNumberDataPoint(tv NumberDataPoint) {
	internal.FillTestMap(internal.NewMap(&tv.getOrig().Attributes, wrappedNumberDataPointAttributes{NumberDataPoint: tv}))
	...
	fillTestExemplarSlice(newExemplarSlice(&tv.getOrig().Exemplars, wrappedNumberDataPointExemplars{NumberDataPoint: tv}))
	tv.getOrig().Flags = 1
}
