...
type pHistogramDataPoint struct {
...
func (es wrappedHistogramDataPointAttributes) RefreshOrigState() (*[]otlpcommon.KeyValue, *internal.State) {
...
func (es wrappedHistogramDataPointAttributes) GetState() *internal.State {
	return es.getState()
}
...
func (es wrappedHistogramDataPointBucketCounts) RefreshOrigState() (*[]uint64, *internal.State) {
...
func (es wrappedHistogramDataPointBucketCounts) GetState() *internal.State {
	return es.getState()
}
...
func (es wrappedHistogramDataPointExplicitBounds) RefreshOrigState() (*[]float64, *internal.State) {
	return &es.getOrig().ExplicitBounds, es.getState()
}
...
func (es wrappedHistogramDataPointExplicitBounds) GetState() *internal.State {
	return es.getState()
}
...
func (es wrappedHistogramDataPointExemplars) RefreshOrigState() (*[]otlpmetrics.Exemplar, *internal.State) {
	return &es.getOrig().Exemplars, es.getState()
}
...
func (es wrappedHistogramDataPointExemplars) GetState() *internal.State {
	return es.getState()
}

func newHistogramDataPoint(orig *otlpmetrics.HistogramDataPoint, parent HistogramDataPointSlice, idx int) HistogramDataPoint {
	return HistogramDataPoint{&pHistogramDataPoint{
		orig:   orig,
...
func NewHistogramDataPoint() HistogramDataPoint {
	...
	return HistogramDataPoint{&pHistogramDataPoint{orig: &otlpmetrics.HistogramDataPoint{}, state: &state}}
}
...
func (ms HistogramDataPoint) Attributes() pcommon.Map {
	return pcommon.Map(internal.NewMap(&ms.getOrig().Attributes, wrappedHistogramDataPointAttributes{HistogramDataPoint: ms}))
}
...
func (ms HistogramDataPoint) BucketCounts() pcommon.UInt64Slice {
	return pcommon.UInt64Slice(internal.NewUInt64Slice(&ms.getOrig().BucketCounts, wrappedHistogramDataPointBucketCounts{HistogramDataPoint: ms}))
}
...
func (ms HistogramDataPoint) ExplicitBounds() pcommon.Float64Slice {
	return pcommon.Float64Slice(internal.NewFloat64Slice(&ms.getOrig().ExplicitBounds, wrappedHistogramDataPointExplicitBounds{HistogramDataPoint: ms}))
}

// Exemplars returns the <no value> associated with this HistogramDataPoint.
func (ms HistogramDataPoint) Exemplars() ExemplarSlice {
	return ExemplarSlice(newExemplarSlice(&ms.getOrig().Exemplars, wrappedHistogramDataPointExemplars{HistogramDataPoint: ms}))
}
