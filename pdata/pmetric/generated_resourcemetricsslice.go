...
func newResourceMetricsSliceFromOrig(orig *[]*otlpmetrics.ResourceMetrics) ResourceMetricsSlice {
	return ResourceMetricsSlice{parent: newMetricsFromResourceMetricsOrig(orig)}
}

func newResourceMetricsSliceFromParent(parent Metrics) ResourceMetricsSlice {
	return ResourceMetricsSlice{parent: parent}
}

func (es ResourceMetricsSlice) getOrig() *[]*otlpmetrics.ResourceMetrics {
	return es.parent.getResourceMetricsOrig()
}
...
func NewResourceMetricsSlice() ResourceMetricsSlice {
	...
	return newResourceMetricsSliceFromOrig(&orig)
}
...
func (es ResourceMetricsSlice) CopyTo(dest ResourceMetricsSlice) {
	...
	if srcLen <= destCap {
		...
		for i := range *es.getOrig() {
			...
			destResourceMetrics := ResourceMetrics{&pResourceMetrics{orig: (*dest.getOrig())[i],
				state: &exclState}}
