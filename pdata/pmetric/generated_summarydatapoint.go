...
func (es wrappedSummaryDataPointAttributes) RefreshOrigState() (*[]otlpcommon.KeyValue, *internal.State) {
...
func (ms SummaryDataPoint) refreshQuantileValuesOrigState() (*[]*otlpmetrics.SummaryDataPoint_ValueAtQuantile, *internal.State) {
	return &ms.getOrig().QuantileValues, ms.state
}
...
func (ms SummaryDataPoint) Attributes() pcommon.Map {
	return pcommon.Map(internal.NewMap(&ms.getOrig().Attributes, wrappedSummaryDataPointAttributes{SummaryDataPoint: ms}))
}
...
func (ms SummaryDataPoint) QuantileValues() SummaryDataPointValueAtQuantileSlice {
	return newSummaryDataPointValueAtQuantileSlice(&ms.getOrig().QuantileValues, ms)
}
