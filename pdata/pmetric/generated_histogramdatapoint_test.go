...
func fillTestHistogramDataPoint(tv HistogramDataPoint) {
	internal.FillTestMap(internal.NewMapFromParent(wrappedHistogramDataPointAttributes{HistogramDataPoint: tv}))
	...
	fillTestExemplarSlice(newExemplarSliceFromParent(wrappedHistogramDataPointExemplars{HistogramDataPoint: tv}))
	tv.getOrig().Flags = 1
