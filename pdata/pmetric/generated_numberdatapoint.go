...
func (es wrappedNumberDataPointAttributes) RefreshOrigState() (*[]otlpcommon.KeyValue, *internal.State) {
...
func (es wrappedNumberDataPointAttributes) GetState() *internal.State {
	return es.getState()
}
...
func (es wrappedNumberDataPointExemplars) RefreshOrigState() (*[]otlpmetrics.Exemplar, *internal.State) {
...
func (es wrappedNumberDataPointExemplars) GetState() *internal.State {
	return es.getState()
}

func newNumberDataPoint(orig *otlpmetrics.NumberDataPoint, parent NumberDataPointSlice, idx int) NumberDataPoint {
	return NumberDataPoint{&pNumberDataPoint{
		orig:   orig,
...
func NewNumberDataPoint() NumberDataPoint {
	...
	return NumberDataPoint{&pNumberDataPoint{orig: &otlpmetrics.NumberDataPoint{}, state: &state}}
}
...
func (ms NumberDataPoint) Attributes() pcommon.Map {
	return pcommon.Map(internal.NewMap(&ms.getOrig().Attributes, wrappedNumberDataPointAttributes{NumberDataPoint: ms}))
}
...
func (ms NumberDataPoint) Exemplars() ExemplarSlice {
	return ExemplarSlice(newExemplarSlice(&ms.getOrig().Exemplars, wrappedNumberDataPointExemplars{NumberDataPoint: ms}))
}
