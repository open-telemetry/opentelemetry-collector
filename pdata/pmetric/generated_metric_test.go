...
func TestMetric_Gauge(t *testing.T) {
	...
	ms.orig.SetGauge(internal.GenTestGauge())
...
func TestMetric_Sum(t *testing.T) {
	...
	ms.orig.SetSum(internal.GenTestSum())
...
func TestMetric_Histogram(t *testing.T) {
	...
	ms.orig.SetHistogram(internal.GenTestHistogram())
...
func TestMetric_ExponentialHistogram(t *testing.T) {
	...
	ms.orig.SetExponentialHistogram(internal.GenTestExponentialHistogram())
...
func TestMetric_Summary(t *testing.T) {
	...
	ms.orig.SetSummary(internal.GenTestSummary())
