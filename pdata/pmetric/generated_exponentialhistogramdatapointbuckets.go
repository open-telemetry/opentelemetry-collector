...
type stubExponentialHistogramDataPointBucketsParent struct {
	orig *otlpmetrics.ExponentialHistogramDataPoint_Buckets
}

func (vp stubExponentialHistogramDataPointBucketsParent) EnsureMutability() {}

func (vp stubExponentialHistogramDataPointBucketsParent) GetChildOrig() *otlpmetrics.ExponentialHistogramDataPoint_Buckets {
	return vp.orig
}

var _ internal.Parent[*otlpmetrics.ExponentialHistogramDataPoint_Buckets] = (*stubExponentialHistogramDataPointBucketsParent)(nil)
...
func (es wrappedExponentialHistogramDataPointBucketsBucketCounts) GetChildOrig() *[]uint64 {
...
func newExponentialHistogramDataPointBucketsFromOrig(orig *otlpmetrics.ExponentialHistogramDataPoint_Buckets) ExponentialHistogramDataPointBuckets {
	return ExponentialHistogramDataPointBuckets{parent: &stubExponentialHistogramDataPointBucketsParent{orig: orig}}
}

func newExponentialHistogramDataPointBucketsFromParent(parent internal.Parent[*otlpmetrics.ExponentialHistogramDataPoint_Buckets]) ExponentialHistogramDataPointBuckets {
	return ExponentialHistogramDataPointBuckets{parent: parent}
}
...
func NewExponentialHistogramDataPointBuckets() ExponentialHistogramDataPointBuckets {
	return newExponentialHistogramDataPointBucketsFromOrig(&otlpmetrics.ExponentialHistogramDataPoint_Buckets{})
}
...
func (ms ExponentialHistogramDataPointBuckets) BucketCounts() pcommon.UInt64Slice {
	return pcommon.UInt64Slice(internal.NewUInt64SliceFromParent(wrappedExponentialHistogramDataPointBucketsBucketCounts{ExponentialHistogramDataPointBuckets: ms}))
}
