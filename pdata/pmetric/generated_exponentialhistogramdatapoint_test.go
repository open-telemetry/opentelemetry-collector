...
func fillTestExponentialHistogramDataPoint(tv ExponentialHistogramDataPoint) {
	internal.FillTestMap(internal.NewMap(&tv.getOrig().Attributes, wrappedExponentialHistogramDataPointAttributes{ExponentialHistogramDataPoint: tv}))
	...
	fillTestExponentialHistogramDataPointBuckets(newExponentialHistogramDataPointBuckets(&tv.getOrig().Positive, wrappedExponentialHistogramDataPointPositive{ExponentialHistogramDataPoint: tv}))
	fillTestExponentialHistogramDataPointBuckets(newExponentialHistogramDataPointBuckets(&tv.getOrig().Negative, wrappedExponentialHistogramDataPointNegative{ExponentialHistogramDataPoint: tv}))
	fillTestExemplarSlice(newExemplarSlice(&tv.getOrig().Exemplars, wrappedExponentialHistogramDataPointExemplars{ExponentialHistogramDataPoint: tv}))
	tv.getOrig().Flags = 1
