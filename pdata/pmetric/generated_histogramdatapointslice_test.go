...
func fillTestHistogramDataPointSlice(es HistogramDataPointSlice) {
	*es.getOrig() = make([]*otlpmetrics.HistogramDataPoint, 7)
	for i := 0; i < 7; i++ {
		(*es.getOrig())[i] = &otlpmetrics.HistogramDataPoint{}
		fillTestHistogramDataPoint(newHistogramDataPointFromOrig((*es.getOrig())[i]))
	}
}
