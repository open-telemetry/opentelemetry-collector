...
func newSpanEventFromOrig(orig *otlptrace.Span_Event) SpanEvent {
	return SpanEvent{parent: newSpanEventSliceFromElementOrig(orig)}
}

func newSpanEventFromParent(parent SpanEventSlice, idx int) SpanEvent {
	return SpanEvent{parent: parent, idx: idx}
}
...
func NewSpanEvent() SpanEvent {
	return newSpanEventFromOrig(&otlptrace.Span_Event{})
}
