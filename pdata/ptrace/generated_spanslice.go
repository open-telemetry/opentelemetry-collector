...
func newSpanSliceFromOrig(orig *[]*otlptrace.Span) SpanSlice {
	return SpanSlice{parent: newScopeSpansFromSpansOrig(orig)}
}

func newSpanSliceFromParent(parent ScopeSpans) SpanSlice {
	return SpanSlice{parent: parent}
}

func (es SpanSlice) getOrig() *[]*otlptrace.Span {
	return es.parent.getSpansOrig()
}
...
func NewSpanSlice() SpanSlice {
	...
	return newSpanSliceFromOrig(&orig)
}
...
func (es SpanSlice) CopyTo(dest SpanSlice) {
	...
	if srcLen <= destCap {
		...
		for i := range *es.getOrig() {
			...
			destSpan := Span{&pSpan{orig: (*dest.getOrig())[i],
				state: &exclState}}
