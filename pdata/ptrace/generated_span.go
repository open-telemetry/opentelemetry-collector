...
func (es wrappedSpanTraceState) RefreshOrigState() (*string, *internal.State) {
...
func (es wrappedSpanTraceState) GetState() *internal.State {
	return es.getState()
}
...
func (es wrappedSpanAttributes) RefreshOrigState() (*[]otlpcommon.KeyValue, *internal.State) {
...
func (es wrappedSpanAttributes) GetState() *internal.State {
	return es.getState()
}

func (ms Span) refreshEventsOrigState() (*[]*otlptrace.Span_Event, *internal.State) {
	return &ms.getOrig().Events, ms.state
}

func (ms Span) refreshLinksOrigState() (*[]*otlptrace.Span_Link, *internal.State) {
	return &ms.getOrig().Links, ms.state
}

func (ms Span) refreshStatusOrigState() (*otlptrace.Status, *internal.State) {
	return &ms.getOrig().Status, ms.state
}

func newSpan(orig *otlptrace.Span, parent SpanSlice, idx int) Span {
	return Span{&pSpan{
		orig:   orig,
...
func NewSpan() Span {
	...
	return Span{&pSpan{orig: &otlptrace.Span{}, state: &state}}
}
...
func (ms Span) TraceState() pcommon.TraceState {
	return pcommon.TraceState(internal.NewTraceState(&ms.getOrig().TraceState, wrappedSpanTraceState{Span: ms}))
}
...
func (ms Span) Attributes() pcommon.Map {
	return pcommon.Map(internal.NewMap(&ms.getOrig().Attributes, wrappedSpanAttributes{Span: ms}))
}
...
func (ms Span) Events() SpanEventSlice {
	return newSpanEventSlice(&ms.getOrig().Events, ms)
}
...
func (ms Span) Links() SpanLinkSlice {
	return newSpanLinkSlice(&ms.getOrig().Links, ms)
}
...
func (ms Span) Status() Status {
	return newStatus(&ms.getOrig().Status, ms)
}
