...
func TestSpanLink_MoveTo(t *testing.T) {
	...
	assert.Panics(t, func() { ms.MoveTo(newSpanLink(internal.NewSpan_Link(), sharedState)) })
	assert.Panics(t, func() { newSpanLink(internal.NewSpan_Link(), sharedState).MoveTo(dest) })
}
...
func TestSpanLink_CopyTo(t *testing.T) {
	...
	sharedState := internal.NewState()
	sharedState.MarkReadOnly()
	assert.Panics(t, func() { ms.CopyTo(newSpanLink(internal.NewSpan_Link(), sharedState)) })
}
...
func generateTestSpanLink() SpanLink {
	ms := newSpanLink(internal.GenTestSpan_Link(), internal.NewState())
	return ms
}
