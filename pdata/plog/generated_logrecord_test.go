...
func fillTestLogRecord(tv LogRecord) {
	...
	internal.FillTestValue(internal.NewValueFromParent(wrappedLogRecordBody{LogRecord: tv}))
	internal.FillTestMap(internal.NewMapFromParent(wrappedLogRecordAttributes{LogRecord: tv}))
