...
func (orig *ExportProfilesServiceRequest) UnmarshalProtoOpts(buf []byte, opts *pdata.UnmarshalOptions) error {
	var err error
	var fieldNum int32
...
func SkipExportProfilesServiceRequestProto(buf []byte) error {
	var err error
	var fieldNum int32
	var wireType proto.WireType
