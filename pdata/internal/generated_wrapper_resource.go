...
func (es WrappedResourceAttributes) RefreshOrigState() (*[]otlpcommon.KeyValue, *State) {
...
func FillTestResource(tv Resource) {
	FillTestMap(NewMap(&tv.GetOrig().Attributes, WrappedResourceAttributes{Resource: tv}))
