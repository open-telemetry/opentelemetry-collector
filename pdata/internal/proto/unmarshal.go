...
// ConsumeLen parses buf starting at pos as a WireTypeLen field, reporting the new position.
func ConsumeLen(buf []byte, pos int) (int, error) {
	var num uint64
	var err error
