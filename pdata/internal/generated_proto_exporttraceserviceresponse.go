...
func (orig *ExportTraceServiceResponse) UnmarshalProtoOpts(buf []byte, opts *pdata.UnmarshalOptions) error {
	var err error
	var fieldNum int32
...
func SkipExportTraceServiceResponseProto(buf []byte) error {
	var err error
	var fieldNum int32
	var wireType proto.WireType
	...
	for pos < l {
		...
		case 1:
			...
			err = SkipExportTracePartialSuccessProto(buf[startPos:pos])
			if err != nil {
				return err
			}
		default:
