...
func (orig *KeyValueList) UnmarshalProtoOpts(buf []byte, opts *pdata.UnmarshalOptions) error {
	var err error
	var fieldNum int32
	...
	for pos < l {
		...
		case 1:
			...
			startPos := pos - length
			orig.Values = append(orig.Values, KeyValue{})
			err = orig.Values[len(orig.Values)-1].UnmarshalProtoOpts(buf[startPos:pos], opts)
			if err != nil {
				return err
			}
		default:
...
func SkipKeyValueListProto(buf []byte) error {
	var err error
	var fieldNum int32
	var wireType proto.WireType
