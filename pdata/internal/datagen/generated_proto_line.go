...
func MarshalJSONLine(orig *Line, dest *json.Stream) {
    dest.WriteObjectStart()
    dest.WriteObjectEnd()
}

func SizeProtoLine(orig *Line) int {
    var n int
    var l int
    _ = l
    return n
...
func MarshalProtoSizedLine(orig *Line, buf []byte) int {
    pos := len(buf)
    var l int
    _ = l
    return len(buf) - pos
...
func UnmarshalProtoLine(orig *Line, buf []byte) error {
    var err error
    var fieldNum int32
