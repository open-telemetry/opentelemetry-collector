...
func MarshalJSONSpanLink(orig *SpanLink, dest *json.Stream) {
    dest.WriteObjectStart()
    dest.WriteObjectEnd()
}

func SizeProtoSpanLink(orig *SpanLink) int {
    var n int
    var l int
    _ = l
    return n
...
func MarshalProtoSizedSpanLink(orig *SpanLink, buf []byte) int {
    pos := len(buf)
    var l int
    _ = l
    return len(buf) - pos
...
func UnmarshalProtoSpanLink(orig *SpanLink, buf []byte) error {
    var err error
    var fieldNum int32
