...
func TestMarshalAndUnmarshalJSONSummaryDataPointValueAtQuantileUnknown(t *testing.T) {
	...
	UnmarshalJSONSummaryDataPointValueAtQuantile(dest, iter)
...
func TestMarshalAndUnmarshalJSONSummaryDataPointValueAtQuantile(t *testing.T) {
	for i, src := range generateTestValuesSummaryDataPointValueAtQuantile() {
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			stream := json.BorrowStream(nil)
			defer json.ReturnStream(stream)
			MarshalJSONSummaryDataPointValueAtQuantile(src, stream)
...
func TestMarshalAndUnmarshalProtoSummaryDataPointValueAtQuantileUnknown(t *testing.T) {
	...
	require.NoError(t, UnmarshalProtoSummaryDataPointValueAtQuantile(dest, []byte{0x88, 0x52, 0xD2, 0x09}))
	assert.Equal(t, NewSummaryDataPointValueAtQuantile(), dest)
}
...
func TestMarshalAndUnmarshalProtoSummaryDataPointValueAtQuantile(t *testing.T) {
	for i, src := range generateTestValuesSummaryDataPointValueAtQuantile(){
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			buf := make([]byte, SizeProtoSummaryDataPointValueAtQuantile(src))
			gotSize := MarshalProtoSizedSummaryDataPointValueAtQuantile(src, buf)
			assert.Equal(t, len(buf), gotSize)

			dest := NewSummaryDataPointValueAtQuantile()
			require.NoError(t, UnmarshalProtoSummaryDataPointValueAtQuantile(dest, buf))
			assert.Equal(t, src, dest)
		})
	}
}
...
func TestMarshalAndUnmarshalProtoViaProtobufSummaryDataPointValueAtQuantile(t *testing.T) {
	for i, src := range generateTestValuesSummaryDataPointValueAtQuantile(){
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			...
			dest := NewSummaryDataPointValueAtQuantile()
			require.NoError(t, UnmarshalProtoSummaryDataPointValueAtQuantile(dest, goBuf))
			assert.Equal(t, src, dest)
		})
	}
}

func generateTestValuesSummaryDataPointValueAtQuantile() []*SummaryDataPointValueAtQuantile {
    return []*<no value>{
		{},
    }
}