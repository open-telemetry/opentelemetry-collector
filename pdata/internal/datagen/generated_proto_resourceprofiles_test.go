...
func TestMarshalAndUnmarshalJSONResourceProfiles(t *testing.T) {
	for i, src := range generateTestValuesResourceProfiles() {
...
func TestMarshalAndUnmarshalProtoResourceProfiles(t *testing.T) {
	for i, src := range generateTestValuesResourceProfiles(){
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			...
			gotSize := MarshalProtoSizedResourceProfiles(src, buf)
...
func generateTestValuesResourceProfiles() []*ResourceProfiles {
    return []*<no value>{
		{},
    }
}