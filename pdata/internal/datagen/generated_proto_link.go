...
func MarshalJSONLink(orig *Link, dest *json.Stream) {
    dest.WriteObjectStart()
    dest.WriteObjectEnd()
}

func SizeProtoLink(orig *Link) int {
    var n int
    var l int
    _ = l
    return n
...
func MarshalProtoSizedLink(orig *Link, buf []byte) int {
    pos := len(buf)
    var l int
    _ = l
    return len(buf) - pos
...
func UnmarshalProtoLink(orig *Link, buf []byte) error {
    var err error
    var fieldNum int32
