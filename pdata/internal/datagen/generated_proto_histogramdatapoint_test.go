...
func TestMarshalAndUnmarshalJSONHistogramDataPoint(t *testing.T) {
	for i, src := range generateTestValuesHistogramDataPoint() {
...
func TestMarshalAndUnmarshalProtoHistogramDataPoint(t *testing.T) {
	for i, src := range generateTestValuesHistogramDataPoint(){
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			...
			gotSize := MarshalProtoSizedHistogramDataPoint(src, buf)
...
func generateTestValuesHistogramDataPoint() []*HistogramDataPoint {
    return []*<no value>{
		{},
    }
}