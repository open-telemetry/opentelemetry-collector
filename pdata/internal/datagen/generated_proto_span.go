...
func MarshalJSONSpan(orig *Span, dest *json.Stream) {
    dest.WriteObjectStart()
    dest.WriteObjectEnd()
}

func SizeProtoSpan(orig *Span) int {
    var n int
    var l int
    _ = l
    return n
...
func MarshalProtoSizedSpan(orig *Span, buf []byte) int {
    pos := len(buf)
    var l int
    _ = l
    return len(buf) - pos
...
func UnmarshalProtoSpan(orig *Span, buf []byte) error {
    var err error
    var fieldNum int32
