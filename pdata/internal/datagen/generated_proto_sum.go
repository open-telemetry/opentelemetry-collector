...
func MarshalJSONSum(orig *Sum, dest *json.Stream) {
    dest.WriteObjectStart()
    dest.WriteObjectEnd()
}

func SizeProtoSum(orig *Sum) int {
    var n int
    var l int
    _ = l
    return n
...
func MarshalProtoSizedSum(orig *Sum, buf []byte) int {
    pos := len(buf)
    var l int
    _ = l
    return len(buf) - pos
...
func UnmarshalProtoSum(orig *Sum, buf []byte) error {
    var err error
    var fieldNum int32
