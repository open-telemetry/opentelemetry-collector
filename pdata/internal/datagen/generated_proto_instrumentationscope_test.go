...
func TestMarshalAndUnmarshalJSONInstrumentationScope(t *testing.T) {
	for i, src := range generateTestValuesInstrumentationScope() {
...
func TestMarshalAndUnmarshalProtoInstrumentationScope(t *testing.T) {
	for i, src := range generateTestValuesInstrumentationScope(){
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			...
			gotSize := MarshalProtoSizedInstrumentationScope(src, buf)
...
func generateTestValuesInstrumentationScope() []*InstrumentationScope {
    return []*<no value>{
		{},
    }
}