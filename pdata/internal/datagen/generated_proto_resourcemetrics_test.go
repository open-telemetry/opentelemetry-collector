...
func TestMarshalAndUnmarshalJSONResourceMetrics(t *testing.T) {
	for i, src := range generateTestValuesResourceMetrics() {
...
func TestMarshalAndUnmarshalProtoResourceMetrics(t *testing.T) {
	for i, src := range generateTestValuesResourceMetrics(){
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			...
			gotSize := MarshalProtoSizedResourceMetrics(src, buf)
...
func generateTestValuesResourceMetrics() []*ResourceMetrics {
    return []*<no value>{
		{},
    }
}