...
func TestMarshalAndUnmarshalJSONExponentialHistogramDataPointBucketsUnknown(t *testing.T) {
	...
	UnmarshalJSONExponentialHistogramDataPointBuckets(dest, iter)
...
func TestMarshalAndUnmarshalJSONExponentialHistogramDataPointBuckets(t *testing.T) {
	for i, src := range generateTestValuesExponentialHistogramDataPointBuckets() {
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			stream := json.BorrowStream(nil)
			defer json.ReturnStream(stream)
			MarshalJSONExponentialHistogramDataPointBuckets(src, stream)
...
func TestMarshalAndUnmarshalProtoExponentialHistogramDataPointBucketsUnknown(t *testing.T) {
	...
	require.NoError(t, UnmarshalProtoExponentialHistogramDataPointBuckets(dest, []byte{0x88, 0x52, 0xD2, 0x09}))
	assert.Equal(t, NewExponentialHistogramDataPointBuckets(), dest)
}
...
func TestMarshalAndUnmarshalProtoExponentialHistogramDataPointBuckets(t *testing.T) {
	for i, src := range generateTestValuesExponentialHistogramDataPointBuckets(){
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			buf := make([]byte, SizeProtoExponentialHistogramDataPointBuckets(src))
			gotSize := MarshalProtoSizedExponentialHistogramDataPointBuckets(src, buf)
			assert.Equal(t, len(buf), gotSize)

			dest := NewExponentialHistogramDataPointBuckets()
			require.NoError(t, UnmarshalProtoExponentialHistogramDataPointBuckets(dest, buf))
			assert.Equal(t, src, dest)
		})
	}
}
...
func TestMarshalAndUnmarshalProtoViaProtobufExponentialHistogramDataPointBuckets(t *testing.T) {
	for i, src := range generateTestValuesExponentialHistogramDataPointBuckets(){
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			...
			dest := NewExponentialHistogramDataPointBuckets()
			require.NoError(t, UnmarshalProtoExponentialHistogramDataPointBuckets(dest, goBuf))
			assert.Equal(t, src, dest)
		})
	}
}

func generateTestValuesExponentialHistogramDataPointBuckets() []*ExponentialHistogramDataPointBuckets {
    return []*<no value>{
		{},
    }
}