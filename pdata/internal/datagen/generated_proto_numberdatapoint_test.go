...
func TestMarshalAndUnmarshalJSONNumberDataPoint(t *testing.T) {
	for i, src := range generateTestValuesNumberDataPoint() {
...
func TestMarshalAndUnmarshalProtoNumberDataPoint(t *testing.T) {
	for i, src := range generateTestValuesNumberDataPoint(){
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			...
			gotSize := MarshalProtoSizedNumberDataPoint(src, buf)
...
func generateTestValuesNumberDataPoint() []*NumberDataPoint {
    return []*<no value>{
		{},
    }
}