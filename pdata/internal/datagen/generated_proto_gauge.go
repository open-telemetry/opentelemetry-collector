...
func MarshalJSONGauge(orig *Gauge, dest *json.Stream) {
    dest.WriteObjectStart()
    dest.WriteObjectEnd()
}

func SizeProtoGauge(orig *Gauge) int {
    var n int
    var l int
    _ = l
    return n
...
func MarshalProtoSizedGauge(orig *Gauge, buf []byte) int {
    pos := len(buf)
    var l int
    _ = l
    return len(buf) - pos
...
func UnmarshalProtoGauge(orig *Gauge, buf []byte) error {
    var err error
    var fieldNum int32
