...
func TestMarshalAndUnmarshalJSONExponentialHistogramDataPoint(t *testing.T) {
	for i, src := range generateTestValuesExponentialHistogramDataPoint() {
...
func TestMarshalAndUnmarshalProtoExponentialHistogramDataPoint(t *testing.T) {
	for i, src := range generateTestValuesExponentialHistogramDataPoint(){
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			...
			gotSize := MarshalProtoSizedExponentialHistogramDataPoint(src, buf)
...
func generateTestValuesExponentialHistogramDataPoint() []*ExponentialHistogramDataPoint {
    return []*<no value>{
		{},
    }
}