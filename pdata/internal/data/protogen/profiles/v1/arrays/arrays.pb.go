...
// source: opentelemetry/proto/profiles/v1/alternatives/arrays/arrays.proto
...
func (SampleType_AggregationTemporality) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_a21ad1b0e4735fa9, []int{3, 0}
}
...
func (Mapping_SymbolFidelity) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_a21ad1b0e4735fa9, []int{6, 0}
}
...
func (*Link) Descriptor() ([]byte, []int) {
	return fileDescriptor_a21ad1b0e4735fa9, []int{0}
}
...
func (*AttributeSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_a21ad1b0e4735fa9, []int{1}
}
...
func (*Stacktrace) Descriptor() ([]byte, []int) {
	return fileDescriptor_a21ad1b0e4735fa9, []int{2}
}
...
type SampleType struct {
	AggregationTemporality SampleType_AggregationTemporality `protobuf:"varint,1,opt,name=aggregation_temporality,json=aggregationTemporality,proto3,enum=opentelemetry.proto.profiles.v1.alternatives.arrays.SampleType_AggregationTemporality" json:"aggregation_temporality,omitempty"`
...
func (*SampleType) Descriptor() ([]byte, []int) {
	return fileDescriptor_a21ad1b0e4735fa9, []int{3}
}
...
type ProfileType struct {
	StacktraceIndices   []uint32 `protobuf:"varint,10,rep,packed,name=stacktrace_indices,json=stacktraceIndices,proto3" json:"stacktrace_indices,omitempty"`
	LinkIndices         []uint32 `protobuf:"varint,11,rep,packed,name=link_indices,json=linkIndices,proto3" json:"link_indices,omitempty"`
	AttributeSetIndices []uint32 `protobuf:"varint,12,rep,packed,name=attribute_set_indices,json=attributeSetIndices,proto3" json:"attribute_set_indices,omitempty"`
	Values              []int64  `protobuf:"varint,13,rep,packed,name=values,proto3" json:"values,omitempty"`
	Timestamps          []uint64 `protobuf:"varint,14,rep,packed,name=timestamps,proto3" json:"timestamps,omitempty"`
}

func (m *ProfileType) Reset()         { *m = ProfileType{} }
func (m *ProfileType) String() string { return proto.CompactTextString(m) }
func (*ProfileType) ProtoMessage()    {}
func (*ProfileType) Descriptor() ([]byte, []int) {
	return fileDescriptor_a21ad1b0e4735fa9, []int{4}
}
func (m *ProfileType) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ProfileType) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ProfileType.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ProfileType) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProfileType.Merge(m, src)
}
func (m *ProfileType) XXX_Size() int {
	return m.Size()
}
func (m *ProfileType) XXX_DiscardUnknown() {
	xxx_messageInfo_ProfileType.DiscardUnknown(m)
}

var xxx_messageInfo_ProfileType proto.InternalMessageInfo

func (m *ProfileType) GetStacktraceIndices() []uint32 {
	if m != nil {
		return m.StacktraceIndices
	}
	return nil
}

func (m *ProfileType) GetLinkIndices() []uint32 {
	if m != nil {
...
func (m *ProfileType) GetAttributeSetIndices() []uint32 {
	if m != nil {
...
func (m *ProfileType) GetValues() []int64 {
	if m != nil {
		return m.Values
	}
	return nil
...
func (m *ProfileType) GetTimestamps() []uint64 {
	if m != nil {
		return m.Timestamps
	}
	return nil
...
type Profile struct {
	...
	ProfileTypes []*ProfileType `protobuf:"bytes,10,rep,name=profile_types,json=profileTypes,proto3" json:"profile_types,omitempty"`
}
...
func (*Profile) Descriptor() ([]byte, []int) {
	return fileDescriptor_a21ad1b0e4735fa9, []int{5}
}
...
func (m *Profile) GetProfileTypes() []*ProfileType {
	if m != nil {
...
type Mapping struct {
	...
	SymbolicInfo Mapping_SymbolFidelity `protobuf:"varint,6,opt,name=symbolic_info,json=symbolicInfo,proto3,enum=opentelemetry.proto.profiles.v1.alternatives.arrays.Mapping_SymbolFidelity" json:"symbolic_info,omitempty"`
...
func (*Mapping) Descriptor() ([]byte, []int) {
	return fileDescriptor_a21ad1b0e4735fa9, []int{6}
}
...
func (*Location) Descriptor() ([]byte, []int) {
	return fileDescriptor_a21ad1b0e4735fa9, []int{7}
}
...
func (*Line) Descriptor() ([]byte, []int) {
	return fileDescriptor_a21ad1b0e4735fa9, []int{8}
}
...
func (*Function) Descriptor() ([]byte, []int) {
	return fileDescriptor_a21ad1b0e4735fa9, []int{9}
}
...
func init() {
	proto.RegisterEnum("opentelemetry.proto.profiles.v1.alternatives.arrays.SampleType_AggregationTemporality", SampleType_AggregationTemporality_name, SampleType_AggregationTemporality_value)
	proto.RegisterEnum("opentelemetry.proto.profiles.v1.alternatives.arrays.Mapping_SymbolFidelity", Mapping_SymbolFidelity_name, Mapping_SymbolFidelity_value)
	proto.RegisterType((*Link)(nil), "opentelemetry.proto.profiles.v1.alternatives.arrays.Link")
	proto.RegisterType((*AttributeSet)(nil), "opentelemetry.proto.profiles.v1.alternatives.arrays.AttributeSet")
	proto.RegisterType((*Stacktrace)(nil), "opentelemetry.proto.profiles.v1.alternatives.arrays.Stacktrace")
	proto.RegisterType((*SampleType)(nil), "opentelemetry.proto.profiles.v1.alternatives.arrays.SampleType")
	proto.RegisterType((*ProfileType)(nil), "opentelemetry.proto.profiles.v1.alternatives.arrays.ProfileType")
	proto.RegisterType((*Profile)(nil), "opentelemetry.proto.profiles.v1.alternatives.arrays.Profile")
	proto.RegisterType((*Mapping)(nil), "opentelemetry.proto.profiles.v1.alternatives.arrays.Mapping")
	proto.RegisterType((*Location)(nil), "opentelemetry.proto.profiles.v1.alternatives.arrays.Location")
	proto.RegisterType((*Line)(nil), "opentelemetry.proto.profiles.v1.alternatives.arrays.Line")
	proto.RegisterType((*Function)(nil), "opentelemetry.proto.profiles.v1.alternatives.arrays.Function")
}

func init() {
	proto.RegisterFile("opentelemetry/proto/profiles/v1/alternatives/arrays/arrays.proto", fileDescriptor_a21ad1b0e4735fa9)
}

var fileDescriptor_a21ad1b0e4735fa9 = []byte{
	...
	,
}
...
func (m *Link) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		...
		i = encodeVarintArrays(dAtA, i, uint64(size))
	}
	i--
	dAtA[i] = 0x12
	{
...
func (m *AttributeSet) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DroppedAttributesCount != 0 {
		i = encodeVarintArrays(dAtA, i, uint64(m.DroppedAttributesCount))
		i--
		dAtA[i] = 0x10
	}
...
func (m *Stacktrace) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.LocationIndices) > 0 {
		...
		i = encodeVarintArrays(dAtA, i, uint64(j1))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *SampleType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.UnitIndex != 0 {
		i = encodeVarintArrays(dAtA, i, uint64(m.UnitIndex))
		i--
		dAtA[i] = 0x20
	}
	if m.TypeIndex != 0 {
		i = encodeVarintArrays(dAtA, i, uint64(m.TypeIndex))
		i--
		dAtA[i] = 0x18
	}
	if m.SampleSize != 0 {
		i = encodeVarintArrays(dAtA, i, uint64(m.SampleSize))
		i--
		dAtA[i] = 0x10
	}
	if m.AggregationTemporality != 0 {
		i = encodeVarintArrays(dAtA, i, uint64(m.AggregationTemporality))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *ProfileType) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ProfileType) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ProfileType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Timestamps) > 0 {
		...
		i = encodeVarintArrays(dAtA, i, uint64(j3))
		i--
		dAtA[i] = 0x72
	}
	if len(m.Values) > 0 {
		...
		i = encodeVarintArrays(dAtA, i, uint64(j5))
		i--
		dAtA[i] = 0x6a
	}
	if len(m.AttributeSetIndices) > 0 {
		dAtA8 := make([]byte, len(m.AttributeSetIndices)*10)
		var j7 int
		...
		i = encodeVarintArrays(dAtA, i, uint64(j7))
		i--
		dAtA[i] = 0x62
	}
	if len(m.LinkIndices) > 0 {
		dAtA10 := make([]byte, len(m.LinkIndices)*10)
		var j9 int
		...
		i = encodeVarintArrays(dAtA, i, uint64(j9))
		i--
		dAtA[i] = 0x5a
	}
	if len(m.StacktraceIndices) > 0 {
		dAtA12 := make([]byte, len(m.StacktraceIndices)*10)
		var j11 int
		for _, num := range m.StacktraceIndices {
			for num >= 1<<7 {
		...
		i = encodeVarintArrays(dAtA, i, uint64(j11))
		i--
		dAtA[i] = 0x52
	}
	return len(dAtA) - i, nil
...
func (m *Profile) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ProfileTypes) > 0 {
		for iNdEx := len(m.ProfileTypes) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ProfileTypes[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.StringTable) > 0 {
		for iNdEx := len(m.StringTable) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintArrays(dAtA, i, uint64(len(m.StringTable[iNdEx])))
			i--
			dAtA[i] = 0x4a
		}
	}
...
func (m *Mapping) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.AttributeSetIndices) > 0 {
		dAtA14 := make([]byte, len(m.AttributeSetIndices)*10)
		var j13 int
		for _, num := range m.AttributeSetIndices {
			for num >= 1<<7 {
		...
		i = encodeVarintArrays(dAtA, i, uint64(j13))
		i--
		dAtA[i] = 0x3a
	}
	if m.SymbolicInfo != 0 {
		i = encodeVarintArrays(dAtA, i, uint64(m.SymbolicInfo))
		i--
		dAtA[i] = 0x30
	}
	if m.BuildIdIndex != 0 {
		i = encodeVarintArrays(dAtA, i, uint64(m.BuildIdIndex))
		i--
		dAtA[i] = 0x28
	}
	if m.FilenameIndex != 0 {
		i = encodeVarintArrays(dAtA, i, uint64(m.FilenameIndex))
		i--
		dAtA[i] = 0x20
	}
	if m.FileOffset != 0 {
		i = encodeVarintArrays(dAtA, i, uint64(m.FileOffset))
		i--
		dAtA[i] = 0x18
	}
	if m.MemoryLimit != 0 {
		i = encodeVarintArrays(dAtA, i, uint64(m.MemoryLimit))
		i--
		dAtA[i] = 0x10
	}
	if m.MemoryStart != 0 {
		i = encodeVarintArrays(dAtA, i, uint64(m.MemoryStart))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Location) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.AttributeSetIndices) > 0 {
		dAtA16 := make([]byte, len(m.AttributeSetIndices)*10)
		var j15 int
		for _, num := range m.AttributeSetIndices {
			for num >= 1<<7 {
		...
		i = encodeVarintArrays(dAtA, i, uint64(j15))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Line) > 0 {
	...
	if m.Address != 0 {
		i = encodeVarintArrays(dAtA, i, uint64(m.Address))
		i--
		dAtA[i] = 0x10
	}
	if m.MappingIndex != 0 {
		i = encodeVarintArrays(dAtA, i, uint64(m.MappingIndex))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Line) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Line != 0 {
		i = encodeVarintArrays(dAtA, i, uint64(m.Line))
		i--
		dAtA[i] = 0x10
	}
	if m.FunctionIndex != 0 {
		i = encodeVarintArrays(dAtA, i, uint64(m.FunctionIndex))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Function) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.StartLine != 0 {
		i = encodeVarintArrays(dAtA, i, uint64(m.StartLine))
		i--
		dAtA[i] = 0x20
	}
	if m.FilenameIndex != 0 {
	...
	if m.SystemNameIndex != 0 {
		i = encodeVarintArrays(dAtA, i, uint64(m.SystemNameIndex))
		i--
		dAtA[i] = 0x10
	}
	if m.NameIndex != 0 {
		i = encodeVarintArrays(dAtA, i, uint64(m.NameIndex))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func encodeVarintArrays(dAtA []byte, offset int, v uint64) int {
	offset -= sovArrays(v)
	base := offset
	for v >= 1<<7 {
...
func (m *AttributeSet) Size() (n int) {
	...
	if m.DroppedAttributesCount != 0 {
		n += 1 + sovArrays(uint64(m.DroppedAttributesCount))
	}
	return n
}
...
func (m *Stacktrace) Size() (n int) {
	...
	if len(m.LocationIndices) > 0 {
		...
		for _, e := range m.LocationIndices {
			l += sovArrays(uint64(e))
		}
		n += 1 + sovArrays(uint64(l)) + l
	}
	return n
}
...
func (m *SampleType) Size() (n int) {
	...
	_ = l
	if m.AggregationTemporality != 0 {
		n += 1 + sovArrays(uint64(m.AggregationTemporality))
	}
	if m.SampleSize != 0 {
		n += 1 + sovArrays(uint64(m.SampleSize))
	}
	if m.TypeIndex != 0 {
		n += 1 + sovArrays(uint64(m.TypeIndex))
	}
	if m.UnitIndex != 0 {
		n += 1 + sovArrays(uint64(m.UnitIndex))
	}
	return n
}

func (m *ProfileType) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.StacktraceIndices) > 0 {
		l = 0
		for _, e := range m.StacktraceIndices {
			l += sovArrays(uint64(e))
		}
		n += 1 + sovArrays(uint64(l)) + l
	}
...
func (m *Mapping) Size() (n int) {
	...
	_ = l
	if m.MemoryStart != 0 {
		n += 1 + sovArrays(uint64(m.MemoryStart))
	}
	if m.MemoryLimit != 0 {
		n += 1 + sovArrays(uint64(m.MemoryLimit))
	}
	if m.FileOffset != 0 {
		n += 1 + sovArrays(uint64(m.FileOffset))
	}
	if m.FilenameIndex != 0 {
		n += 1 + sovArrays(uint64(m.FilenameIndex))
	}
	if m.BuildIdIndex != 0 {
		n += 1 + sovArrays(uint64(m.BuildIdIndex))
	}
	if m.SymbolicInfo != 0 {
		n += 1 + sovArrays(uint64(m.SymbolicInfo))
	}
	if len(m.AttributeSetIndices) > 0 {
		l = 0
		for _, e := range m.AttributeSetIndices {
...
func (m *Location) Size() (n int) {
	...
	_ = l
	if m.MappingIndex != 0 {
		n += 1 + sovArrays(uint64(m.MappingIndex))
	}
	if m.Address != 0 {
		n += 1 + sovArrays(uint64(m.Address))
	}
	if len(m.Line) > 0 {
...
func (m *Line) Size() (n int) {
	...
	_ = l
	if m.FunctionIndex != 0 {
		n += 1 + sovArrays(uint64(m.FunctionIndex))
	}
	if m.Line != 0 {
		n += 1 + sovArrays(uint64(m.Line))
	}
	return n
}
...
func (m *Function) Size() (n int) {
	...
	_ = l
	if m.NameIndex != 0 {
		n += 1 + sovArrays(uint64(m.NameIndex))
	}
	if m.SystemNameIndex != 0 {
		n += 1 + sovArrays(uint64(m.SystemNameIndex))
	}
	if m.FilenameIndex != 0 {
		n += 1 + sovArrays(uint64(m.FilenameIndex))
	}
	if m.StartLine != 0 {
		n += 1 + sovArrays(uint64(m.StartLine))
	}
	return n
}

func sovArrays(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozArrays(x uint64) (n int) {
	return sovArrays(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *Link) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		default:
			iNdEx = preIndex
			skippy, err := skipArrays(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func (m *ProfileType) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 10:
			if wireType == 0 {
				...
				m.StacktraceIndices = append(m.StacktraceIndices, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.StacktraceIndices) == 0 {
					m.StacktraceIndices = make([]uint32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint32
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field StacktraceIndices", wireType)
			}
		case 11:
			if wireType == 0 {
				var v uint32
...
func (m *Profile) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			m.ProfileTypes = append(m.ProfileTypes, &ProfileType{})
			if err := m.ProfileTypes[len(m.ProfileTypes)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func skipArrays(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthArrays
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupArrays
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthArrays        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowArrays          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupArrays = fmt.Errorf("proto: unexpected end of group")
)
