...
func TestInstrumentationScope_MoveTo(t *testing.T) {
	...
	dest := NewMutableInstrumentationScope()
	ms.MoveTo(dest)
	assert.Equal(t, NewMutableInstrumentationScope(), ms)
	assert.Equal(t, GenerateTestInstrumentationScope(), dest)
}

func TestInstrumentationScope_CopyTo(t *testing.T) {
	ms := NewMutableInstrumentationScope()
	orig := NewMutableInstrumentationScope()
	orig.CopyTo(ms)
