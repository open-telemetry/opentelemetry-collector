	...
	for pos < l {
		...
		case 1:
			if wireType != proto.WireTypeVarint {
				return fmt.Errorf("proto: wrong wireType = %d for field MappingIndex_.(*otlpprofiles.Location_MappingIndex).MappingIndex", wireType)
			}
			var num uint64
			...
			orig.MappingIndex_.(*otlpprofiles.Location_MappingIndex).MappingIndex = int32(num)
		...
		case 3:
			...
			return UnmarshalProtoOrigLine(orig.Line[len(orig.Line)-1], buf[prevPos:pos])
