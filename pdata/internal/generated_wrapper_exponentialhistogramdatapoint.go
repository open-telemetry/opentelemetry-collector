...
func UnmarshalProtoOrigExponentialHistogramDataPoint(orig *otlpmetrics.ExponentialHistogramDataPoint, buf []byte) error {
	...
	for pos < l {
		...
		case 5:
			if wireType != proto.WireTypeI64 {
				return fmt.Errorf("proto: wrong wireType = %d for field Sum_.(*otlpmetrics.ExponentialHistogramDataPoint_Sum).Sum", wireType)
			}
			var num uint64
			num, pos, err = proto.ConsumeI64(buf, pos)
			if err != nil {
			...
			orig.Sum_.(*otlpmetrics.ExponentialHistogramDataPoint_Sum).Sum = math.Float64frombits(num)
		...
		case 8:
			...
			return UnmarshalProtoOrigExponentialHistogramDataPoint_Buckets(&orig.Positive, buf[prevPos:pos])
		...
		case 9:
			...
			return UnmarshalProtoOrigExponentialHistogramDataPoint_Buckets(&orig.Negative, buf[prevPos:pos])
		...
		case 12:
			if wireType != proto.WireTypeI64 {
				return fmt.Errorf("proto: wrong wireType = %d for field Min_.(*otlpmetrics.ExponentialHistogramDataPoint_Min).Min", wireType)
			}
			var num uint64
			num, pos, err = proto.ConsumeI64(buf, pos)
			if err != nil {
			...
			orig.Min_.(*otlpmetrics.ExponentialHistogramDataPoint_Min).Min = math.Float64frombits(num)

		case 13:
			if wireType != proto.WireTypeI64 {
				return fmt.Errorf("proto: wrong wireType = %d for field Max_.(*otlpmetrics.ExponentialHistogramDataPoint_Max).Max", wireType)
			}
			var num uint64
			num, pos, err = proto.ConsumeI64(buf, pos)
			if err != nil {
			...
			orig.Max_.(*otlpmetrics.ExponentialHistogramDataPoint_Max).Max = math.Float64frombits(num)
