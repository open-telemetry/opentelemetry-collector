...
//
// Must use NewMetricDataPointFlags function to create new instances.
...
// NoRecordedValue returns the norecordedvalue associated with this MetricDataPointFlags.
func (ms MetricDataPointFlags) NoRecordedValue() bool {
	return (*ms.orig)&1 != 0
}

// SetNoRecordedValue replaces the norecordedvalue associated with this MetricDataPointFlags.
func (ms MetricDataPointFlags) SetNoRecordedValue(v bool) {
	if v {
		*ms.orig = (*ms.orig) | 1
	} else {
		*ms.orig = (*ms.orig) &^ 1
