...
func MarshalProtoOrigExemplar(orig *otlpmetrics.Exemplar, buf []byte) int {
	...
	case *otlpmetrics.Exemplar_AsDouble:
		pos -= 8
		encoding_binary.LittleEndian.PutUint64(buf[pos:], math.Float64bits(orig.Value.(*otlpmetrics.Exemplar_AsDouble).AsDouble))
		pos--
		buf[pos] = 0x19

	case *otlpmetrics.Exemplar_AsInt:
		pos -= 8
		encoding_binary.LittleEndian.PutUint64(buf[pos:], math.Float64bits(orig.Value.(*otlpmetrics.Exemplar_AsInt).AsInt))
		pos--
		buf[pos] = 0x31
