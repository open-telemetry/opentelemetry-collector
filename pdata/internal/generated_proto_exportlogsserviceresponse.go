...
func (orig *ExportLogsServiceResponse) UnmarshalProtoOpts(buf []byte, opts *pdata.UnmarshalOptions) error {
	var err error
	var fieldNum int32
...
func SkipExportLogsServiceResponseProto(buf []byte) error {
	var err error
	var fieldNum int32
	var wireType proto.WireType
	...
	for pos < l {
		...
		case 1:
			...
			err = SkipExportLogsPartialSuccessProto(buf[startPos:pos])
			if err != nil {
				return err
			}
		default:
