...
func GetOrigValue(ms Value) *AnyValue {
	return ms.orig
}
...
func NewValueWrapper(orig *AnyValue, state *State) Value {
...
func GenTestValueWrapper() Value {
	return NewValueWrapper(GenTestAnyValue(), NewState())
}
