...
func (orig *ExportLogsPartialSuccess) UnmarshalProtoUnsafe(buf []byte) error {
	return orig.unmarshalProto(buf, true)
}

func (orig *ExportLogsPartialSuccess) unmarshalProto(buf []byte, unsafeUnmarshal bool) error {
	var err error
	var fieldNum int32
