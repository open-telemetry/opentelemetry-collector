...
func NewCompareConfig(opts []CompareOption) *CompareConfig {
	cfg := &CompareConfig{
		floatTolerance: 0, // default is strict equality (0 tolerance) for backward compatibility
...
// If tolerance is 0 (default), uses strict equality comparison for backward compatibility.
