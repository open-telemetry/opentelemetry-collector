...
func TestResourceEntityRef_MoveTo(t *testing.T) {
	ms := ResourceEntityRef(internal.GenerateTestResourceEntityRef())
	dest := NewResourceEntityRef()
	ms.MoveTo(dest)
	assert.Equal(t, NewResourceEntityRef(), ms)
	assert.Equal(t, ResourceEntityRef(internal.GenerateTestResourceEntityRef()), dest)
...
func TestResourceEntityRef_CopyTo(t *testing.T) {
	...
	orig = ResourceEntityRef(internal.GenerateTestResourceEntityRef())
	orig.CopyTo(ms)
	assert.Equal(t, orig, ms)
	sharedState := internal.StateReadOnly
