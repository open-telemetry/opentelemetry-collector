...
func (ms Resource) getOrig() *otlpresource.Resource {
	return internal.Resource(ms).GetOrig()
}

func (ms Resource) ensureMutability() {
	internal.Resource(ms).EnsureMutability()
}
...
func NewResource() Resource {
	return Resource(internal.NewResource(&otlpresource.Resource{}, nil))
}
...
// Attributes returns the <no value> associated with this Resource.
func (ms Resource) Attributes() Map {
	return Map(internal.NewMap(&ms.getOrig().Attributes, internal.WrappedResourceAttributes{Resource: internal.Resource(ms)}))
}
