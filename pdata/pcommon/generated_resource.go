...
func NewResource() Resource {
	return Resource(internal.NewResourceFromOrig(&otlpresource.Resource{}))
}
...
func (ms Resource) Attributes() Map {
	return Map(internal.NewMapFromParent(internal.WrappedResourceAttributes{Resource: internal.Resource(ms)}))
}
