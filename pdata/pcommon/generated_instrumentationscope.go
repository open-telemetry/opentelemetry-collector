...
func NewInstrumentationScope() InstrumentationScope {
	return InstrumentationScope(internal.NewInstrumentationScope(&otlpcommon.InstrumentationScope{}, nil))
}
...
func (ms InstrumentationScope) Attributes() Map {
	return Map(internal.NewMap(&ms.getOrig().Attributes, internal.WrappedInstrumentationScopeAttributes{InstrumentationScope: internal.InstrumentationScope(ms)}))
}
