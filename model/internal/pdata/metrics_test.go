...
func TestOtlpToInternalReadOnly(t *testing.T) {
	...
	assert.EqualValues(t, NewMapFromRaw(map[string]Value{
	...
	assert.EqualValues(t, NewMapFromRaw(map[string]Value{"key0": NewValueString("value0")}), gaugeDataPoints.At(0).Attributes())
	// Second point
	...
	assert.EqualValues(t, NewMapFromRaw(map[string]Value{"key1": NewValueString("value1")}), gaugeDataPoints.At(1).Attributes())
	...
	assert.EqualValues(t, NewMapFromRaw(map[string]Value{"key0": NewValueString("value0")}), sumDataPoints.At(0).Attributes())
	// Second point
	...
	assert.EqualValues(t, NewMapFromRaw(map[string]Value{"key1": NewValueString("value1")}), sumDataPoints.At(1).Attributes())
	...
	assert.EqualValues(t, NewMapFromRaw(map[string]Value{"key0": NewValueString("value0")}), histogramDataPoints.At(0).Attributes())
	...
	assert.EqualValues(t, NewMapFromRaw(map[string]Value{"key1": NewValueString("value1")}), histogramDataPoints.At(1).Attributes())
...
func TestOtlpToFromInternalGaugeMutating(t *testing.T) {
	newAttributes := NewMapFromRaw(map[string]Value{"k": NewValueString("v")})
