...
func (ms InstrumentationLibraryLogs) InstrumentationLibrary() pcommon.InstrumentationLibrary {
...
func (ms LogRecord) Body() pcommon.AttributeValue {
	return pcommon.AttributeValueFromOrig(&(*ms.orig).Body)
}

// Attributes returns the Attributes associated with this LogRecord.
func (ms LogRecord) Attributes() pcommon.AttributeMap {
