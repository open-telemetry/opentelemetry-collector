...
func (ms ResourceSpans) Resource() pcommon.Resource {
	return pcommon.ResourceFromOrig(&(*ms.orig).Resource)
}
...
func (ms InstrumentationLibrarySpans) InstrumentationLibrary() pcommon.InstrumentationLibrary {
	return pcommon.InstrumentationLibraryFromOrig(&(*ms.orig).InstrumentationLibrary)
}
...
func (ms Span) Attributes() pcommon.AttributeMap {
	return pcommon.AttributeMapFromOrig(&(*ms.orig).Attributes)
}
...
func (ms SpanEvent) Attributes() pcommon.AttributeMap {
	return pcommon.AttributeMapFromOrig(&(*ms.orig).Attributes)
}
...
func (ms SpanLink) Attributes() pcommon.AttributeMap {
	return pcommon.AttributeMapFromOrig(&(*ms.orig).Attributes)
}
