...
type CreateTracesReceiver func(context.Context, component.ComponentSettings, config.Receiver, consumer.Traces) (component.TracesReceiver, error)

// CreateMetricsReceiver is the equivalent of component.ReceiverFactory.CreateMetricsReceiver()
type CreateMetricsReceiver func(context.Context, component.ComponentSettings, config.Receiver, consumer.Metrics) (component.MetricsReceiver, error)

// CreateLogsReceiver is the equivalent of component.ReceiverFactory.CreateLogsReceiver()
type CreateLogsReceiver func(context.Context, component.ComponentSettings, config.Receiver, consumer.Logs) (component.LogsReceiver, error)
...
func (f *factory) CreateTracesReceiver(
	...
	if f.createTracesReceiver != nil {
		return f.createTracesReceiver(ctx, componentSettings, cfg, nextConsumer)
	}
...
func (f *factory) CreateMetricsReceiver(
	...
	if f.createMetricsReceiver != nil {
		return f.createMetricsReceiver(ctx, componentSettings, cfg, nextConsumer)
	}
	return nil, componenterror.ErrDataTypeIsNotSupported
}
...
func (f *factory) CreateLogsReceiver(
	...
	if f.createLogsReceiver != nil {
		return f.createLogsReceiver(ctx, componentSettings, cfg, nextConsumer)
	}
	return nil, componenterror.ErrDataTypeIsNotSupported
}
