...
func TestCreateReceiver(t *testing.T) {
	...
	tReceiver, err := createTracesReceiver(context.Background(), componentSettings, cfg, nil)
	assert.NotNil(t, tReceiver)
	assert.NoError(t, err)

	mReceiver, err := createMetricsReceiver(context.Background(), componentSettings, cfg, nil)
...
func TestCreateTracesReceiver(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tr, err := createTracesReceiver(ctx, componentSettings, tt.cfg, consumertest.NewNop())
...
func TestCreateMetricReceiver(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tc, err := createMetricsReceiver(context.Background(), componentSettings, tt.cfg, consumertest.NewNop())
			if (err != nil) != tt.wantErr {
