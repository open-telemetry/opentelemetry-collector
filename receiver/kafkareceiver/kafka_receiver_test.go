...
func TestNewTracesReceiver_version_err(t *testing.T) {
	...
	r, err := newTracesReceiver(c, componenttest.NewTestReceiverCreateSettings(t), defaultTracesUnmarshalers(), consumertest.NewNop())
	assert.Error(t, err)
	assert.Nil(t, r)
}
...
func TestNewMetricsReceiver_version_err(t *testing.T) {
	...
	r, err := newMetricsReceiver(c, componenttest.NewTestReceiverCreateSettings(t), defaultMetricsUnmarshalers(), consumertest.NewNop())
	assert.Error(t, err)
	assert.Nil(t, r)
}
...
func TestNewLogsReceiver_version_err(t *testing.T) {
	...
	r, err := newLogsReceiver(c, componenttest.NewTestReceiverCreateSettings(t), defaultLogsUnmarshalers(), consumertest.NewNop())
	assert.Error(t, err)
	assert.Nil(t, r)
}
