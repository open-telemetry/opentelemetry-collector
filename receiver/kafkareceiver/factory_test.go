...
func TestCreateTracesReceiver(t *testing.T) {
	...
	r, err := f.createTracesReceiver(context.Background(), component.ComponentSettings{}, cfg, nil)
	// no available broker
	require.Error(t, err)
	assert.Nil(t, r)
}
...
func TestWithTracesUnmarshalers(t *testing.T) {
	...
	t.Run("custom_encoding", func(t *testing.T) {
		...
		receiver, err := f.CreateTracesReceiver(context.Background(), component.ComponentSettings{}, cfg, nil)
		require.NoError(t, err)
...
func TestCreateLogsReceiver(t *testing.T) {
	...
	r, err := f.createLogsReceiver(context.Background(), component.ComponentSettings{}, cfg, nil)
	// no available broker
	require.Error(t, err)
	assert.Nil(t, r)
}
...
func TestWithLogsUnmarshalers(t *testing.T) {
	...
	t.Run("custom_encoding", func(t *testing.T) {
		cfg.Encoding = unmarshaler.Encoding()
		exporter, err := f.CreateLogsReceiver(context.Background(), component.ComponentSettings{}, cfg, nil)
		require.NoError(t, err)
