...
func TestCreateTracesReceiver(t *testing.T) {
	...
	r, err := f.createTracesReceiver(context.Background(), componenttest.NewTestReceiverCreateSettings(t), cfg, nil)
	// no available broker
	require.Error(t, err)
	assert.Nil(t, r)
}
...
func TestWithTracesUnmarshalers(t *testing.T) {
	...
	t.Run("custom_encoding", func(t *testing.T) {
		...
		receiver, err := f.CreateTracesReceiver(context.Background(), componenttest.NewTestReceiverCreateSettings(t), cfg, nil)
		require.NoError(t, err)
...
func TestCreateMetricsReceiver(t *testing.T) {
	...
	r, err := f.createMetricsReceiver(context.Background(), componenttest.NewTestReceiverCreateSettings(t), cfg, nil)
	// no available broker
	require.Error(t, err)
	assert.Nil(t, r)
}
...
func TestWithMetricsUnmarshalers(t *testing.T) {
	...
	t.Run("custom_encoding", func(t *testing.T) {
		cfg.Encoding = unmarshaler.Encoding()
		receiver, err := f.CreateMetricsReceiver(context.Background(), componenttest.NewTestReceiverCreateSettings(t), cfg, nil)
		require.NoError(t, err)
		require.NotNil(t, receiver)
	})
	t.Run("default_encoding", func(t *testing.T) {
...
func TestCreateLogsReceiver(t *testing.T) {
	...
	r, err := f.createLogsReceiver(context.Background(), componenttest.NewTestReceiverCreateSettings(t), cfg, nil)
	// no available broker
	require.Error(t, err)
	assert.Nil(t, r)
}
...
func TestWithLogsUnmarshalers(t *testing.T) {
	...
	t.Run("custom_encoding", func(t *testing.T) {
		cfg.Encoding = unmarshaler.Encoding()
		exporter, err := f.CreateLogsReceiver(context.Background(), componenttest.NewTestReceiverCreateSettings(t), cfg, nil)
		require.NoError(t, err)
