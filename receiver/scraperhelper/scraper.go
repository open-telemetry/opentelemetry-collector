...
type ScrapeFunc func(context.Context) (metrics.Metrics, error)

func (sf ScrapeFunc) Scrape(ctx context.Context) (metrics.Metrics, error) {
	return sf(ctx)
}
...
type Scraper interface {
	...
	Scrape(context.Context) (metrics.Metrics, error)
}
