...
func (r *otlpReceiver) startHTTPServer(ctx context.Context, host component.Host) error {
	...
	if r.nextTraces != nil {
		...
		httpMux.HandleFunc(string(r.cfg.HTTP.Get().TracesURLPath), func(resp http.ResponseWriter, req *http.Request) {
	...
	if r.nextMetrics != nil {
		...
		httpMux.HandleFunc(string(r.cfg.HTTP.Get().MetricsURLPath), func(resp http.ResponseWriter, req *http.Request) {
	...
	if r.nextLogs != nil {
		...
		httpMux.HandleFunc(string(r.cfg.HTTP.Get().LogsURLPath), func(resp http.ResponseWriter, req *http.Request) {
