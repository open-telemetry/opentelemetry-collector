...
func TestCreateTracesReceiver(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			tr, err := factory.CreateTracesReceiver(ctx, componentSettings, tt.cfg, sink)
			assert.NoError(t, err)
			require.NotNil(t, tr)
			if tt.wantErr {
...
func TestCreateMetricReceiver(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			mr, err := factory.CreateMetricsReceiver(ctx, componentSettings, tt.cfg, sink)
			assert.NoError(t, err)
			require.NotNil(t, mr)
			if tt.wantErr {
...
func TestCreateLogReceiver(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			mr, err := factory.CreateLogsReceiver(ctx, componentSettings, tt.cfg, tt.sink)
			if tt.wantErr {
				assert.Error(t, err)
				return
			}
