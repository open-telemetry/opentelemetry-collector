...
func initializeMemoryUsageMetric(metric pdata.Metric, now time.Time, memInfo *mem.VirtualMemoryStat) {
...
func initializeMemoryUsageDataPoint(dataPoint pdata.IntDataPoint, now time.Time, stateLabel string, value int64) {
