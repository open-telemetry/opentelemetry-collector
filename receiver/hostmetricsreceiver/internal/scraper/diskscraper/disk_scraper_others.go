...
func initializeDiskIOMetric(metric pdata.Metric, startTime, now time.Time, ioCounters map[string]disk.IOCountersStat) {
...
func initializeDiskOperationsMetric(metric pdata.Metric, startTime, now time.Time, ioCounters map[string]disk.IOCountersStat) {
...
func initializeDiskIOTimeMetric(metric pdata.Metric, startTime, now time.Time, ioCounters map[string]disk.IOCountersStat) {
...
func initializeDiskOperationTimeMetric(metric pdata.Metric, startTime, now time.Time, ioCounters map[string]disk.IOCountersStat) {
...
func initializeDiskPendingOperationsMetric(metric pdata.Metric, now time.Time, ioCounters map[string]disk.IOCountersStat) {
