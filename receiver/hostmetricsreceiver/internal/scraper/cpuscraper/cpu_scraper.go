...
func initializeCPUTimeMetric(metric pdata.Metric, startTime, now time.Time, cpuTimes []cpu.TimesStat) {
...
func initializeCPUTimeDataPoint(dataPoint pdata.DoubleDataPoint, startTime, now time.Time, cpuLabel string, stateLabel string, value float64) {
