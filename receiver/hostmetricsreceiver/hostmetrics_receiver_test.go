...
func TestGatherMetrics_EndToEnd(t *testing.T) {
	...
	receiver, err := NewFactory().CreateMetricsReceiver(context.Background(), componenttest.NewTestReceiverCreateSettings(t), cfg, sink)
...
func TestGatherMetrics_ScraperKeyConfigError(t *testing.T) {
	...
	_, err := NewFactory().CreateMetricsReceiver(context.Background(), componenttest.NewTestReceiverCreateSettings(t), cfg, sink)
	require.Error(t, err)
}
