...
type exampleReceiver struct {
	nextLogsConsumer    consumerlogs.Logs
	nextTracesConsumer  consumertraces.Traces
	nextMetricsConsumer consumermetrics.Metrics
}
...
func createTrace(_ context.Context, _ receiver.CreateSettings, cfg component.Config, consumer consumertraces.Traces) (receiver.Traces, error) {
	rcv := &exampleReceiver{nextTracesConsumer: consumer}
	cfg.(*exampleReceiverConfig).generator.(*exampleTraceGenerator).receiver = rcv
	return rcv, nil
}

func createMetric(_ context.Context, _ receiver.CreateSettings, cfg component.Config, consumer consumermetrics.Metrics) (receiver.Metrics, error) {
