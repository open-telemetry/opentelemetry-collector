...
func NewOcaStore(ctx context.Context, sink consumer.MetricsConsumer, logger *zap.SugaredLogger, metricExportNameMap map[string]string, jobExportPrefixMap map[string]string, jobsMap *JobsMap) OcaStore {
	return &ocaStore{
...
func (o *ocaStore) Appender() (storage.Appender, error) {
	...
	if state == runningStateReady {
		return newTransaction(o.ctx, o.metricExportNameMap, o.jobExportPrefixMap, o.jobsMap, o.mc, o.sink, o.logger), nil
