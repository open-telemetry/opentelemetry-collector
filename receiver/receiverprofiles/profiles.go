...
// Profiles receiver feeds a consumerexp.Profiles with data.
//
...
type Factory interface {
	...
	CreateProfiles(ctx context.Context, set receiver.Settings, cfg component.Config, next consumerexp.Profiles) (Profiles, error)
...
type CreateProfilesFunc func(context.Context, receiver.Settings, component.Config, consumerexp.Profiles) (Profiles, error)

// CreateProfiles implements Factory.CreateProfiles.
func (f CreateProfilesFunc) CreateProfiles(ctx context.Context, set receiver.Settings, cfg component.Config, next consumerexp.Profiles) (Profiles, error) {
	if f == nil {
