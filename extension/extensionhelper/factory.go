...
type CreateServiceExtension func(context.Context, component.ComponentSettings, config.Extension) (component.Extension, error)
...
func (f *factory) CreateExtension(
	...
	return f.createServiceExtension(ctx, componentSettings, cfg)
}
