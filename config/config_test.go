	...
	for _, test := range testCases {
		...
		assert.Equalf(t,
			&ExampleExtension{
				...
				ExtraMapSetting:  map[string]string{"ext_1": extensionExtraMapValue + "_1", "ext_2": extensionExtraMapValue + "_2"},
		...
		assert.Equalf(t,
			&ExampleReceiver{
				...
				ExtraMapSetting:  map[string]string{"recv_1": receiverExtraMapValue + "_1", "recv_2": receiverExtraMapValue + "_2"},
