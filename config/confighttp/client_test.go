...
func TestAllHTTPClientSettings(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			client, err := tt.settings.ToClient(context.Background(), tel, WithClientExtensions(extensions))
			if tt.shouldError {
				assert.Error(t, err)
				return
			}
...
func TestProxyURL(t *testing.T) {
	...
	for _, tt := range testCases {
		t.Run(tt.name, func(t *testing.T) {
			...
			tel := componenttest.NewNopTelemetrySettings()
			tel.TracerProvider = nil
			client, err := s.ToClient(context.Background(), tel)
...
func TestHTTPClientSettingWithAuthConfig(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Omit TracerProvider and MeterProvider in TelemetrySettings as otelhttp.Transport cannot be introspected
			client, err := tt.settings.ToClient(context.Background(), nilProvidersSettings, WithClientExtensions(tt.extensions))
			if tt.shouldErr {
				assert.Error(t, err)
				return
			}
...
func TestHttpClientHeaders(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			client, _ := setting.ToClient(context.Background(), componenttest.NewNopTelemetrySettings())
...
func TestHttpTransportOptions(t *testing.T) {
	...
	client, err := clientConfig.ToClient(context.Background(), settings)
	require.NoError(t, err)
