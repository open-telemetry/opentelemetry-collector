...
func expandStringValues(value interface{}) interface{} {
	...
	case []interface{}:
		// Viper treats all the slices as []interface{} (at least in what the otcol tests).
	...
	case map[string]interface{}:
		...
		// Viper treats all the maps as [string]interface{} (at least in what the otcol tests).
		for k, vint := range v {
