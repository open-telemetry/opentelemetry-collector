...
func TestDecodeConfig(t *testing.T) {
	...
	assert.Equal(t, config.ServiceTelemetry{Logs: config.ServiceTelemetryLogs{Level: zapcore.DebugLevel,
		Development: true, Encoding: "console", EnableGrpcLogs: true}}, cfg.Service.Telemetry)
