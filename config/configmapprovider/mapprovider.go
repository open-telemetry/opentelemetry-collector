...
type MapProvider interface {
	...
	Retrieve(ctx context.Context, onChange func(*ChangeEvent)) (RetrievedMap, error)
}

// RetrievedMap holds the result of a call to the Retrieve method of a Provider object.
//
