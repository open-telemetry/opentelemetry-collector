...
// NewPropertiesMapProvider returns a Provider, that provides a config.Map from the given properties.
//
...
func NewPropertiesMapProvider(properties []string) Provider {
