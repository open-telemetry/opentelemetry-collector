...
// newSignalProcessor shuts the metrics down when exporterhelper does not take ownership of them.
...
func newTracesProcessor(ctx context.Context, set processor.Settings, cfg *Config, next consumer.Traces) (processor.Traces, error) {
	return newSignalProcessor(set, pipeline.SignalTraces, cfg.Sizer, func(obsMetrics exporterhelper.ObsMetrics) (processor.Traces, error) {
...
func newMetricsProcessor(ctx context.Context, set processor.Settings, cfg *Config, next consumer.Metrics) (processor.Metrics, error) {
	return newSignalProcessor(set, pipeline.SignalMetrics, cfg.Sizer, func(obsMetrics exporterhelper.ObsMetrics) (processor.Metrics, error) {
...
func newLogsProcessor(ctx context.Context, set processor.Settings, cfg *Config, next consumer.Logs) (processor.Logs, error) {
	return newSignalProcessor(set, pipeline.SignalLogs, cfg.Sizer, func(obsMetrics exporterhelper.ObsMetrics) (processor.Logs, error) {
...
func newProfilesProcessor(ctx context.Context, set processor.Settings, cfg *Config, next xconsumer.Profiles) (xprocessor.Profiles, error) {
	return newSignalProcessor(set, xpipeline.SignalProfiles, cfg.Sizer, func(obsMetrics exporterhelper.ObsMetrics) (xprocessor.Profiles, error) {
