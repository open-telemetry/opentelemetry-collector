...
func NewSettings(tt *componenttest.Telemetry) processor.Settings {
	...
	set.ID = component.NewID(component.MustNewType("queue_batch"))
...
func AssertEqualProcessorQueuebatchBatchSendSize(t *testing.T, tt *componenttest.Telemetry, dps []metricdata.HistogramDataPoint[int64], opts ...metricdatatest.Option) {
	want := metricdata.Metrics{
		...
		Description: "Number of items in the batch. Only recorded when batching is enabled. Only available on detailed level. [Development]",
		Unit:        "{item}",
...
func AssertEqualProcessorQueuebatchEnqueueSize(t *testing.T, tt *componenttest.Telemetry, dps []metricdata.HistogramDataPoint[int64], opts ...metricdatatest.Option) {
	want := metricdata.Metrics{
		...
		Description: "Number of items in a request offered to the queue, including rejected offers. Only available on detailed level. [Development]",
		Unit:        "{item}",
		Data: metricdata.Histogram[int64]{
			Temporality: metricdata.CumulativeTemporality,
			DataPoints:  dps,
