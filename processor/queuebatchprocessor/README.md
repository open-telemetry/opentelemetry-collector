...
The queue/batch processor accepts spans, metrics, or logs and places
them into batches, using the [exporterhelper sending queue and
batch](../../exporter/exporterhelper/README.md#sending-queue) logic
and configuration.
...
Span names and attributes are renamed in a similar manner.
