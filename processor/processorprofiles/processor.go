...
type Factory interface {
	...
	CreateProfiles(ctx context.Context, set processor.Settings, cfg component.Config, next consumerexp.Profiles) (Profiles, error)
...
// CreateProfilesFunc is the equivalent of Factory.CreateProfiles().
type CreateProfilesFunc func(context.Context, processor.Settings, component.Config, consumerexp.Profiles) (Profiles, error)

// CreateProfiles implements Factory.CreateProfiles.
func (f CreateProfilesFunc) CreateProfiles(ctx context.Context, set processor.Settings, cfg component.Config, next consumerexp.Profiles) (Profiles, error) {
	if f == nil {
