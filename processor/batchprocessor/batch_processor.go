...
//
// batch_processor implements consumertraces.Traces and consumermetrics.Metrics
//
...
var _ consumertraces.Traces = (*batchProcessor)(nil)
var _ consumermetrics.Metrics = (*batchProcessor)(nil)
var _ consumerlogs.Logs = (*batchProcessor)(nil)
...
func newBatchTracesProcessor(set processor.CreateSettings, next consumertraces.Traces, cfg *Config) (*batchProcessor, error) {
...
func newBatchMetricsProcessor(set processor.CreateSettings, next consumermetrics.Metrics, cfg *Config) (*batchProcessor, error) {
...
func newBatchLogsProcessor(set processor.CreateSettings, next consumerlogs.Logs, cfg *Config) (*batchProcessor, error) {
...
func newBatchTraces(nextConsumer consumertraces.Traces) *batchTraces {
...
func newBatchMetrics(nextConsumer consumermetrics.Metrics) *batchMetrics {
...
func newBatchLogs(nextConsumer consumerlogs.Logs) *batchLogs {
