...
| Deprecation of logs | [Date]: 2026-08-03   |
|                      | [Migration Note]: Use the queuebatchprocessor instead; see docs/rfcs/batching-migration.md   |
| Deprecation of metrics | [Date]: 2026-08-03   |
|                      | [Migration Note]: Use the queuebatchprocessor instead; see docs/rfcs/batching-migration.md   |
| Deprecation of traces | [Date]: 2026-08-03   |
|                      | [Migration Note]: Use the queuebatchprocessor instead; see docs/rfcs/batching-migration.md   |
...
> [!NOTE]
> This processor is being replaced by [`queuebatchprocessor`](../queuebatchprocessor/README.md)
> as described in the [batching-migration RFC](../../docs/rfcs/batching-migration.md).
