...
The batch processor is deprecated. In most cases, exporters have
integrated support for batching within the `sending_queue`
configuration, part of [exporterhelper](../../exporter/exporterhelper/README.md).
If you require batching in a processor component, consider using the
[`pipelineprocessor`](../pipelineprocessor/README.md) which exposes these
