...
func TestBatchProcessorSentBySize(t *testing.T) {
	sizer := otlp.NewProtobufTracesMarshaler().(ptrace.TracesSizer)
	views := MetricViews()
...
func TestBatchMetricProcessor_BatchSize(t *testing.T) {
	sizer := otlp.NewProtobufMetricsMarshaler().(pmetric.MetricsSizer)
	views := MetricViews()
	require.NoError(t, view.Register(views...))
	defer view.Unregister(views...)
...
func TestBatchLogProcessor_BatchSize(t *testing.T) {
	sizer := otlp.NewProtobufLogsMarshaler().(plog.LogsSizer)
	views := MetricViews()
	require.NoError(t, view.Register(views...))
	defer view.Unregister(views...)
