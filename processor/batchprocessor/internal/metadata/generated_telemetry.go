...
func NewTelemetryBuilder(settings component.TelemetrySettings, options ...TelemetryBuilderOption) (*TelemetryBuilder, error) {
	...
	builder.ProcessorBatchBatchSendSize, err = builder.meter.Int64Histogram(
		...
		metric.WithDescription("Number of units in the batchDevelopment"),
	...
	builder.ProcessorBatchBatchSizeTriggerSend, err = builder.meter.Int64Counter(
		...
		metric.WithDescription("Number of times the batch was sent due to a size triggerDevelopment"),
		metric.WithUnit("{times}"),
	)
	errs = errors.Join(errs, err)
	builder.ProcessorBatchMetadataCardinality, err = builder.meter.Int64ObservableUpDownCounter(
		"otelcol_processor_batch_metadata_cardinality",
		metric.WithDescription("Number of distinct metadata value combinations being processedDevelopment"),
		metric.WithUnit("{combinations}"),
	)
	errs = errors.Join(errs, err)
	builder.ProcessorBatchTimeoutTriggerSend, err = builder.meter.Int64Counter(
		"otelcol_processor_batch_timeout_trigger_send",
		metric.WithDescription("Number of times the batch was sent due to a timeout triggerDevelopment"),
		metric.WithUnit("{times}"),
	)
	errs = errors.Join(errs, err)
	return &builder, errs
