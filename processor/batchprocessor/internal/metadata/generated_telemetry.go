...
func NewTelemetryBuilder(settings component.TelemetrySettings, options ...TelemetryBuilderOption) (*TelemetryBuilder, error) {
	...
	builder.ProcessorBatchBatchSendSizeBytes, err = builder.meter.Int64Histogram(
		...
		metric.WithUnit("By"),
		metric.WithExplicitBucketBoundaries([]float64{1024, 2048, 4096, 8192, 16384, 32768, 65536, 131072, 262144, 524288, 1.048576e+06, 2.097152e+06, 4.194304e+06, 8.388608e+06, 1.6777216e+07}...),
	)
	errs = errors.Join(errs, err)
