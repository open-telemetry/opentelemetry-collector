...
func TestLogProcessor_NilEmptyData(t *testing.T) {
	...
	tp, err := factory.CreateLogsProcessor(
		context.Background(), componenttest.NewTestProcessorCreateSettings(t), oCfg, consumertest.NewNop())
	require.Nil(t, err)
	require.NotNil(t, tp)
...
func TestAttributes_FilterLogs(t *testing.T) {
	...
	tp, err := factory.CreateLogsProcessor(context.Background(), componenttest.NewTestProcessorCreateSettings(t), cfg, consumertest.NewNop())
	require.Nil(t, err)
	require.NotNil(t, tp)
