...
type ProcessTracesFunc func(context.Context, traces.Traces) (traces.Traces, error)
...
func NewTracesProcessor(
	...
	traceConsumer, err := consumer.NewTraces(func(ctx context.Context, td traces.Traces) error {
