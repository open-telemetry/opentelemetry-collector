...
type ProcessMetricsFunc func(context.Context, metrics.Metrics) (metrics.Metrics, error)
...
func NewMetricsProcessor(
	...
	metricsConsumer, err := consumer.NewMetrics(func(ctx context.Context, md metrics.Metrics) error {
