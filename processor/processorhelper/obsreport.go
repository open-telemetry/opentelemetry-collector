...
func (or *obsReport) recordInOut(ctx context.Context, incoming, outgoing, incomingBytes, outgoingBytes int) {
	...
	or.telemetryBuilder.ProcessorIncomingItemsBytes.Add(ctx, int64(incomingBytes), or.otelAttrs)
	or.telemetryBuilder.ProcessorOutgoingItemsBytes.Add(ctx, int64(outgoingBytes), or.otelAttrs)
}
