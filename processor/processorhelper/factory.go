...
type CreateTracesProcessor func(context.Context, component.ComponentSettings, config.Processor, consumer.Traces) (component.TracesProcessor, error)

// CreateMetricsProcessor is the equivalent of component.ProcessorFactory.CreateMetricsProcessor()
type CreateMetricsProcessor func(context.Context, component.ComponentSettings, config.Processor, consumer.Metrics) (component.MetricsProcessor, error)

// CreateLogsProcessor is the equivalent of component.ProcessorFactory.CreateLogsProcessor()
type CreateLogsProcessor func(context.Context, component.ComponentSettings, config.Processor, consumer.Logs) (component.LogsProcessor, error)
...
func (f *factory) CreateTracesProcessor(
	...
	if f.createTracesProcessor == nil {
		return f.BaseProcessorFactory.CreateTracesProcessor(ctx, componentSettings, cfg, nextConsumer)
	}
	return f.createTracesProcessor(ctx, componentSettings, cfg, nextConsumer)
}
...
func (f *factory) CreateMetricsProcessor(
	...
	if f.createMetricsProcessor == nil {
		return f.BaseProcessorFactory.CreateMetricsProcessor(ctx, componentSettings, cfg, nextConsumer)
	}
	return f.createMetricsProcessor(ctx, componentSettings, cfg, nextConsumer)
}
...
func (f *factory) CreateLogsProcessor(
	...
	if f.createLogsProcessor == nil {
		return f.BaseProcessorFactory.CreateLogsProcessor(ctx, componentSettings, cfg, nextConsumer)
	}
	return f.createLogsProcessor(ctx, componentSettings, cfg, nextConsumer)
}
