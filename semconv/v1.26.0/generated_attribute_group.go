...
const (
	...
	// Note: If the collection name is parsed from the query, it SHOULD match the
	// value provided in the query and may be qualified with the schema and database
	// name.
...
const (
	...
	// client. For example, when using OpenAI client libraries to communicate with
	// Mistral, the gen_ai.system is set to openai based on the instrumentation's best
	// knowledge.
...
const (
	...
	AttributeMessagingOperationTypeDeliver = "process"
