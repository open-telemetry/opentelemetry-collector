...
type loggingExporter struct {
	logger           *zap.Logger
	logsMarshaler    logs.Marshaler
	metricsMarshaler metrics.Marshaler
	tracesMarshaler  traces.Marshaler
}

func (s *loggingExporter) pushTraces(_ context.Context, td traces.Traces) error {
...
func (s *loggingExporter) pushMetrics(_ context.Context, md metrics.Metrics) error {
...
func (s *loggingExporter) pushLogs(_ context.Context, ld logs.Logs) error {
