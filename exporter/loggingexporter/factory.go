...
func createTracesExporter(_ context.Context, _ component.ComponentSettings, config config.Exporter) (component.TracesExporter, error) {
	cfg := config.(*Config)
...
func createMetricsExporter(_ context.Context, _ component.ComponentSettings, config config.Exporter) (component.MetricsExporter, error) {
	cfg := config.(*Config)
...
func createLogsExporter(_ context.Context, _ component.ComponentSettings, config config.Exporter) (component.LogsExporter, error) {
	cfg := config.(*Config)
