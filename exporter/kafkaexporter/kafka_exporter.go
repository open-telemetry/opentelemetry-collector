...
func newMetricsExporter(config Config, componentSettings component.ComponentSettings, marshalers map[string]MetricsMarshaler) (*kafkaMetricsProducer, error) {
...
func newTracesExporter(config Config, componentSettings component.ComponentSettings, marshalers map[string]TracesMarshaler) (*kafkaTracesProducer, error) {
	marshaler := marshalers[config.Encoding]
	if marshaler == nil {
		return nil, errUnrecognizedEncoding
	}
...
func newLogsExporter(config Config, params component.ComponentSettings, marshalers map[string]LogsMarshaler) (*kafkaLogsProducer, error) {
	marshaler := marshalers[config.Encoding]
	if marshaler == nil {
		return nil, errUnrecognizedEncoding
	}
