...
func TestCreateTracesExporter(t *testing.T) {
	...
	r, err := f.createTracesExporter(context.Background(), componenttest.NewTestExporterCreateSettings(t), cfg)
...
func TestCreateMetricsExport(t *testing.T) {
	...
	mr, err := mf.createMetricsExporter(context.Background(), componenttest.NewTestExporterCreateSettings(t), cfg)
	require.NoError(t, err)
	assert.NotNil(t, mr)
}
...
func TestCreateLogsExport(t *testing.T) {
	...
	mr, err := mf.createLogsExporter(context.Background(), componenttest.NewTestExporterCreateSettings(t), cfg)
	require.NoError(t, err)
	assert.NotNil(t, mr)
}
...
func TestWithMarshalers(t *testing.T) {
	...
	t.Run("custom_encoding", func(t *testing.T) {
		...
		exporter, err := f.CreateTracesExporter(context.Background(), componenttest.NewTestExporterCreateSettings(t), cfg)
		require.NoError(t, err)
