...
var (
	fakeTracesExporterName   = component.NewIDWithName(component.MustType("fake_traces_exporter"), "with_name")
...
func TestTracesExporter_WithPersistentQueue(t *testing.T) {
	...
	set.ID = component.NewIDWithName(component.MustType("test_traces"), "with_persistent_queue")
