...
func TestTracesExporter_InvalidName(t *testing.T) {
	te, err := NewTracesExporter(nil, componenttest.NewTestExporterCreateSettings(t), newTraceDataPusher(nil))
	require.Nil(t, te)
...
func TestTracesExporter_NilPushTraceData(t *testing.T) {
	te, err := NewTracesExporter(&fakeTracesExporterConfig, componenttest.NewTestExporterCreateSettings(t), nil)
	require.Nil(t, te)
...
func TestTracesExporter_Default(t *testing.T) {
	td := pdata.NewTraces()
	te, err := NewTracesExporter(&fakeTracesExporterConfig, componenttest.NewTestExporterCreateSettings(t), newTraceDataPusher(nil))
	assert.NotNil(t, te)
...
func TestTracesExporter_WithCapabilities(t *testing.T) {
	...
	te, err := NewTracesExporter(&fakeTracesExporterConfig, componenttest.NewTestExporterCreateSettings(t), newTraceDataPusher(nil), WithCapabilities(capabilities))
	assert.NotNil(t, te)
	assert.NoError(t, err)
...
func TestTracesExporter_Default_ReturnError(t *testing.T) {
	...
	te, err := NewTracesExporter(&fakeTracesExporterConfig, componenttest.NewTestExporterCreateSettings(t), newTraceDataPusher(want))
...
func TestTracesExporter_WithRecordEnqueueFailedMetrics(t *testing.T) {
	...
	te, err := NewTracesExporter(&fakeTracesExporterConfig, componenttest.NewTestExporterCreateSettings(t), newTraceDataPusher(wantErr), WithRetry(rCfg), WithQueue(qCfg))
	require.NoError(t, err)
	require.NotNil(t, te)
...
func TestTracesExporter_WithShutdown(t *testing.T) {
	...
	te, err := NewTracesExporter(&fakeTracesExporterConfig, componenttest.NewTestExporterCreateSettings(t), newTraceDataPusher(nil), WithShutdown(shutdown))
	assert.NotNil(t, te)
	assert.NoError(t, err)
...
func TestTracesExporter_WithShutdown_ReturnError(t *testing.T) {
	...
	te, err := NewTracesExporter(&fakeTracesExporterConfig, componenttest.NewTestExporterCreateSettings(t), newTraceDataPusher(nil), WithShutdown(shutdownErr))
	assert.NotNil(t, te)
	assert.NoError(t, err)
