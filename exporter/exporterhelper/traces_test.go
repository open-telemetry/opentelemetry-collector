...
var (
	fakeTracesExporterName   = component.NewIDWithName(component.MustNewType("fake_traces_exporter"), "with_name")
...
func TestTracesExporter_WithPersistentQueue(t *testing.T) {
	...
	set.ID = component.NewIDWithName(component.MustNewType("test_traces"), "with_persistent_queue")
