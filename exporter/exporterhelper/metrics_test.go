...
var (
	metricsExporterID  = config.NewIDWithName("fake_metrics_exporter", "with_name")
	metricsExporterCfg = config.NewExporterSettings()
)
...
func TestMetricsExporter_NilLogger(t *testing.T) {
	me, err := NewMetricsExporter(&metricsExporterCfg, component.ExporterCreateSettings{}, newPushMetricsData(nil))
	require.Nil(t, me)
	require.Equal(t, errNilLogger, err)
}

func TestMetricsExporter_NilPushMetricsData(t *testing.T) {
	me, err := NewMetricsExporter(&metricsExporterCfg, componenttest.NewNopExporterCreateSettings(metricsExporterID), nil)
	require.Nil(t, me)
...
func TestMetricsExporter_Default(t *testing.T) {
	md := pdata.NewMetrics()
	me, err := NewMetricsExporter(&metricsExporterCfg, componenttest.NewNopExporterCreateSettings(metricsExporterID), newPushMetricsData(nil))
...
func TestMetricsExporter_WithCapabilities(t *testing.T) {
	...
	me, err := NewMetricsExporter(&metricsExporterCfg, componenttest.NewNopExporterCreateSettings(metricsExporterID), newPushMetricsData(nil), WithCapabilities(capabilities))
	assert.NoError(t, err)
	assert.NotNil(t, me)
...
func TestMetricsExporter_Default_ReturnError(t *testing.T) {
	...
	me, err := NewMetricsExporter(&metricsExporterCfg, componenttest.NewNopExporterCreateSettings(metricsExporterID), newPushMetricsData(want))
...
func TestMetricsExporter_WithRecordEnqueueFailedMetrics(t *testing.T) {
	...
	te, err := NewMetricsExporter(&metricsExporterCfg, componenttest.NewNopExporterCreateSettings(metricsExporterID), newPushMetricsData(wantErr), WithRetry(rCfg), WithQueue(qCfg))
	require.NoError(t, err)
	require.NotNil(t, te)
	...
	checkExporterEnqueueFailedMetricsStats(t, metricsExporterID, int64(10))
}

func TestMetricsExporter_WithSpan(t *testing.T) {
	set := componenttest.NewNopExporterCreateSettings(metricsExporterID)
	sr := new(oteltest.SpanRecorder)
	set.TracerProvider = oteltest.NewTracerProvider(oteltest.WithSpanRecorder(sr))
	otel.SetTracerProvider(set.TracerProvider)
	defer otel.SetTracerProvider(trace.NewNoopTracerProvider())

	me, err := NewMetricsExporter(&metricsExporterCfg, set, newPushMetricsData(nil))
	require.NoError(t, err)
	require.NotNil(t, me)
...
func TestMetricsExporter_WithSpan_ReturnError(t *testing.T) {
	...
	want := errors.New("my_error")
	me, err := NewMetricsExporter(&metricsExporterCfg, set, newPushMetricsData(want))
	require.NoError(t, err)
	require.NotNil(t, me)
...
func TestMetricsExporter_WithShutdown(t *testing.T) {
	...
	me, err := NewMetricsExporter(&metricsExporterCfg, componenttest.NewNopExporterCreateSettings(metricsExporterID), newPushMetricsData(nil), WithShutdown(shutdown))
	assert.NotNil(t, me)
	assert.NoError(t, err)
...
func TestMetricsExporter_WithResourceToTelemetryConversionDisabled(t *testing.T) {
	...
	me, err := NewMetricsExporter(&metricsExporterCfg, componenttest.NewNopExporterCreateSettings(metricsExporterID), newPushMetricsData(nil), WithResourceToTelemetryConversion(defaultResourceToTelemetrySettings()))
	assert.NotNil(t, me)
	assert.NoError(t, err)
...
func TestMetricsExporter_WithResourceToTelemetryConversionEnabled(t *testing.T) {
	md := testdata.GenerateMetricsTwoMetrics()
	me, err := NewMetricsExporter(&metricsExporterCfg, componenttest.NewNopExporterCreateSettings(metricsExporterID), newPushMetricsData(nil), WithResourceToTelemetryConversion(ResourceToTelemetrySettings{Enabled: true}))
	assert.NotNil(t, me)
	assert.NoError(t, err)
...
func TestMetricsExporter_WithShutdown_ReturnError(t *testing.T) {
	...
	me, err := NewMetricsExporter(&metricsExporterCfg, componenttest.NewNopExporterCreateSettings(metricsExporterID), newPushMetricsData(nil), WithShutdown(shutdownErr))
	assert.NotNil(t, me)
	assert.NoError(t, err)
...
func checkRecordedMetricsForMetricsExporter(t *testing.T, me component.MetricsExporter, wantError error) {
	...
	if wantError != nil {
		obsreporttest.CheckExporterMetrics(t, metricsExporterID, 0, numPoints)
	} else {
		obsreporttest.CheckExporterMetrics(t, metricsExporterID, numPoints, 0)
	}
}
