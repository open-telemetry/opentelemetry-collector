...
func TestMetricsRequest(t *testing.T) {
	...
	metricsErr := cmetricerror.NewMetrics(errors.New("some error"), pmetric.NewMetrics())
	assert.EqualValues(
		t,
...
func newPushMetricsData(retError error) cmetric.ConsumeMetricsFunc {
