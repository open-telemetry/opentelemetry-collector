...
func checkRecordedMetricsForMetricsExporter(t *testing.T, tt obsreporttest.TestTelemetry, me exporter.MetricsExporter, wantError error) {
...
func generateMetricsTraffic(t *testing.T, tracer trace.Tracer, me exporter.MetricsExporter, numRequests int, wantError error) {
	md := testdata.GenerateMetrics(1)
...
func checkWrapSpanForMetricsExporter(t *testing.T, sr *tracetest.SpanRecorder, tracer trace.Tracer, me exporter.MetricsExporter, wantError error, numMetricPoints int64) {
	const numRequests = 5
