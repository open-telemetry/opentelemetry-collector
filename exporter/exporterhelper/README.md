...
**Feature Gate**: This feature is currently behind the `exporter.RequestMiddleware` feature gate (alpha stage). Enable it with `--feature-gates=exporter.RequestMiddleware=true`.
