...
func AssertEqualExporterDroppedLogRecords(t *testing.T, tt *componenttest.Telemetry, dps []metricdata.DataPoint[int64], opts ...metricdatatest.Option) {
	want := metricdata.Metrics{
		...
		Description: "Number of log records intentionally dropped by the exporter (e.g. unsupported data). At detailed telemetry level, includes attribute: exporter.dropped.reason. [Alpha]",
		Unit:        "{record}",
...
func AssertEqualExporterDroppedMetricPoints(t *testing.T, tt *componenttest.Telemetry, dps []metricdata.DataPoint[int64], opts ...metricdatatest.Option) {
	want := metricdata.Metrics{
		...
		Description: "Number of metric points intentionally dropped by the exporter (e.g. unsupported temporality). At detailed telemetry level, includes attribute: exporter.dropped.reason. [Alpha]",
		Unit:        "{datapoint}",
		Data: metricdata.Sum[int64]{
			Temporality: metricdata.CumulativeTemporality,
			IsMonotonic: true,
...
func AssertEqualExporterDroppedProfileSamples(t *testing.T, tt *componenttest.Telemetry, dps []metricdata.DataPoint[int64], opts ...metricdatatest.Option) {
	want := metricdata.Metrics{
		Name:        "otelcol_exporter_dropped_profile_samples",
		Description: "Number of profile samples intentionally dropped by the exporter. At detailed telemetry level, includes attribute: exporter.dropped.reason. [Development]",
		Unit:        "{sample}",
		Data: metricdata.Sum[int64]{
			Temporality: metricdata.CumulativeTemporality,
			IsMonotonic: true,
	...
	got, err := tt.GetMetric("otelcol_exporter_dropped_profile_samples")
	require.NoError(t, err)
	metricdatatest.AssertEqual(t, want, got, opts...)
}
...
func AssertEqualExporterDroppedSpans(t *testing.T, tt *componenttest.Telemetry, dps []metricdata.DataPoint[int64], opts ...metricdatatest.Option) {
	want := metricdata.Metrics{
		...
		Description: "Number of spans intentionally dropped by the exporter (e.g. unsupported data). At detailed telemetry level, includes attribute: exporter.dropped.reason. [Alpha]",
		Unit:        "{span}",
		Data: metricdata.Sum[int64]{
			Temporality: metricdata.CumulativeTemporality,
			IsMonotonic: true,
