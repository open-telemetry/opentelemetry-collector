...
func (tt *TestTelemetry) NewSettings() exporter.Settings {
...
func (tt *TestTelemetry) AssertMetrics(t *testing.T, expected []metricdata.Metrics, opts ...metricdatatest.Option) {
