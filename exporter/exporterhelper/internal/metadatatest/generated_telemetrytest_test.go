...
func TestSetupTelemetry(t *testing.T) {
	...
	tb.AddExporterEnqueueFailedLogRecords(context.Background(), 1)
	tb.AddExporterEnqueueFailedMetricPoints(context.Background(), 1)
	tb.AddExporterEnqueueFailedSpans(context.Background(), 1)
	tb.AddExporterSendFailedLogRecords(context.Background(), 1)
	tb.AddExporterSendFailedMetricPoints(context.Background(), 1)
	tb.AddExporterSendFailedSpans(context.Background(), 1)
	tb.AddExporterSentLogRecords(context.Background(), 1)
	tb.AddExporterSentMetricPoints(context.Background(), 1)
	tb.AddExporterSentSpans(context.Background(), 1)
