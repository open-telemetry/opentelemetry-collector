...
func TestExporterObsMetricsAttributes(t *testing.T) {
	...
	for name, want := range map[string]attribute.Set{
		...
		"otelcol_exporter_queue_batch_send_size":       attribute.NewSet(exporterAttr, signalAttr),
		"otelcol_exporter_queue_batch_send_size_bytes": attribute.NewSet(exporterAttr, signalAttr),
