...
var (
	fakeLogsExporterName   = component.NewIDWithName(component.MustType("fake_logs_exporter"), "with_name")
...
func TestLogsExporter_WithPersistentQueue(t *testing.T) {
	...
	set.ID = component.NewIDWithName(component.MustType("test_logs"), "with_persistent_queue")
