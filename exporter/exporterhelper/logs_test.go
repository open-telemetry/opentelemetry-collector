...
func checkRecordedMetricsForLogsExporter(t *testing.T, tt obsreporttest.TestTelemetry, le exporter.LogsExporter, wantError error) {
...
func generateLogsTraffic(t *testing.T, tracer trace.Tracer, le exporter.LogsExporter, numRequests int, wantError error) {
...
func checkWrapSpanForLogsExporter(t *testing.T, sr *tracetest.SpanRecorder, tracer trace.Tracer, le exporter.LogsExporter, wantError error, numLogRecords int64) {
	const numRequests = 5
