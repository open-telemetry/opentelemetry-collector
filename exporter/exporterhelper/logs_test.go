...
var (
	fakeLogsExporterName   = component.NewIDWithName(component.MustNewType("fake_logs_exporter"), "with_name")
...
func TestLogsExporter_WithPersistentQueue(t *testing.T) {
	...
	set.ID = component.NewIDWithName(component.MustNewType("test_logs"), "with_persistent_queue")
