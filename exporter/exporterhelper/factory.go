...
type CreateTracesExporter func(context.Context, component.ComponentSettings, config.Exporter) (component.TracesExporter, error)

// CreateMetricsExporter is the equivalent of component.ExporterFactory.CreateMetricsExporter()
type CreateMetricsExporter func(context.Context, component.ComponentSettings, config.Exporter) (component.MetricsExporter, error)

// CreateLogsExporter is the equivalent of component.ExporterFactory.CreateLogsExporter()
type CreateLogsExporter func(context.Context, component.ComponentSettings, config.Exporter) (component.LogsExporter, error)
...
func (f *factory) CreateTracesExporter(
	...
	if f.createTracesExporter != nil {
		return f.createTracesExporter(ctx, componentSettings, cfg)
	}
...
func (f *factory) CreateMetricsExporter(
	...
	if f.createMetricsExporter != nil {
		return f.createMetricsExporter(ctx, componentSettings, cfg)
	}
	return nil, componenterror.ErrDataTypeIsNotSupported
}
...
func (f *factory) CreateLogsExporter(
	...
	if f.createLogsExporter != nil {
		return f.createLogsExporter(ctx, componentSettings, cfg)
	}
	return nil, componenterror.ErrDataTypeIsNotSupported
}
