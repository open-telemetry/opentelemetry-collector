module go.opentelemetry.io/collector/exporter/exporterhelper/xexporterhelper/xexporterhelpertest
...
replace go.opentelemetry.io/collector/exporter/exporterhelper/xexporterhelper => ..
