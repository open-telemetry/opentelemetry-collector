...
func newTracesRequest(ctx context.Context, td traces.Traces, pusher consumer.ConsumeTracesFunc) request {
...
func NewTracesExporter(
	...
	tc, err := consumer.NewTraces(func(ctx context.Context, td traces.Traces) error {
