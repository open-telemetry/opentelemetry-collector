...
var _ persistentqueue.Encoding[Request] = tracesEncoding{}
...
func (tracesEncoding) MarshalTo(req Request, b []byte) (int, error) {
	return tracesMarshaler.MarshalTracesToSizedBuffer(req.(*tracesRequest).td, b)
}

func (tracesEncoding) MarshalSize(req Request) int {
	return tracesMarshaler.TracesSize(req.(*tracesRequest).td)
}
