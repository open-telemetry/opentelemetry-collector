...
const (
	// DefaultAgentPort is the default destination port.
	DefaultAgentPort uint16 = 55678
	// DefaultAgentHost is the default destination address.
	DefaultAgentHost string = "localhost"
)

// ExporterOption is the interface to implement configuration options.
...
// WithReconnectionPeriod configures the delay before a gRPC re-connection is
