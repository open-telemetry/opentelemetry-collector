...
require (
	...
	go.opentelemetry.io/collector/config/configauth v0.116.1
	...
	go.opentelemetry.io/collector/consumer/consumererror v0.116.1
	go.opentelemetry.io/collector/exporter v0.116.1
	go.opentelemetry.io/collector/exporter/exporterhelper/xexporterhelper v0.116.1
...
require (
	...
	go.opentelemetry.io/collector/extension v0.116.1 // indirect
	...
	go.opentelemetry.io/collector/pipeline v0.116.1 // indirect
	go.opentelemetry.io/collector/pipeline/xpipeline v0.116.1 // indirect
	go.opentelemetry.io/collector/receiver v0.116.1 // indirect
	go.opentelemetry.io/collector/receiver/receivertest v0.116.1 // indirect
