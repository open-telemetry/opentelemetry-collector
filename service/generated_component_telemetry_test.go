...
import (
	...
	"go.opentelemetry.io/collector/pkg"
	"go.opentelemetry.io/collector/pkg/pkgtest"
)
...
func (tt *componentTestTelemetry) NewCreateSettings() pkg.CreateSettings {
	settings := pkgtest.NewNopCreateSettings()
	settings.MeterProvider = tt.meterProvider
	settings.ID = component.NewID(component.MustNewType("service"))
