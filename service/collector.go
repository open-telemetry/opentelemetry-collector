...
func New(set CollectorSettings) (*Collector, error) {
	...
	if set.ConfigMapProvider == nil {
		...
		set.ConfigMapProvider = configmapprovider.Default()
	}
...
func (col *Collector) setupConfigurationComponents(ctx context.Context) error {
	...
	if watchable, ok := col.set.ConfigMapProvider.(configmapprovider.Watchable); ok {
...
func (col *Collector) watchForConfigUpdates(watchable configmapprovider.Watchable) {
