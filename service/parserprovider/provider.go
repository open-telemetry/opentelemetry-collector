...
// Watcher is an extension for ParserProvider that is implemented if the given provider
...
// Closer is an extension interface for ParserProvider that should be added if they need to be closed.
