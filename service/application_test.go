...
func TestApplication_Start(t *testing.T) {
	...
	app, err := New(Parameters{Factories: factories, BinaryInfo: component.DefaultBinaryInfo(), LoggingOptions: []zap.Option{zap.Hooks(hook)}})
	require.NoError(t, err)
...
func TestApplication_ReportError(t *testing.T) {
	...
	app, err := New(Parameters{Factories: factories, BinaryInfo: component.DefaultBinaryInfo()})
	require.NoError(t, err)
