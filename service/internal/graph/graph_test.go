...
// TestReloadReceiverAlreadyMarkedForRemoval verifies that when a receiver is already
// marked for removal, it is not duplicated in the rebuild list.
func TestReloadReceiverAlreadyMarkedForRemoval(t *testing.T) {
	t.Run("with_internal_telemetry", func(t *testing.T) {
		setObsConsumerGateForTest(t, true)
		testReloadReceiverAlreadyMarkedForRemoval(t)
	})
	t.Run("without_internal_telemetry", func(t *testing.T) {
		setObsConsumerGateForTest(t, false)
		testReloadReceiverAlreadyMarkedForRemoval(t)
...
// processors are rebuilt but exporters remain untouched.
...
func TestReloadAddNewExporterToExistingPipeline(t *testing.T) {
	t.Run("with_internal_telemetry", func(t *testing.T) {
		setObsConsumerGateForTest(t, true)
		testReloadAddNewExporterToExistingPipeline(t)
	})
	t.Run("without_internal_telemetry", func(t *testing.T) {
		setObsConsumerGateForTest(t, false)
		testReloadAddNewExporterToExistingPipeline(t)
...
func TestReloadRemoveExporterFromPipeline(t *testing.T) {
	t.Run("with_internal_telemetry", func(t *testing.T) {
		setObsConsumerGateForTest(t, true)
		testReloadRemoveExporterFromPipeline(t)
	})
	t.Run("without_internal_telemetry", func(t *testing.T) {
		setObsConsumerGateForTest(t, false)
		testReloadRemoveExporterFromPipeline(t)
...
func TestReloadWithConnectorAsReceiverInPipeline(t *testing.T) {
	t.Run("with_internal_telemetry", func(t *testing.T) {
		setObsConsumerGateForTest(t, true)
		testReloadWithConnectorAsReceiverInPipeline(t)
	})
	t.Run("without_internal_telemetry", func(t *testing.T) {
		setObsConsumerGateForTest(t, false)
		testReloadWithConnectorAsReceiverInPipeline(t)
...
func TestReloadAddNewConnectorBetweenExistingPipelines(t *testing.T) {
	t.Run("with_internal_telemetry", func(t *testing.T) {
		setObsConsumerGateForTest(t, true)
		testReloadAddNewConnectorBetweenExistingPipelines(t)
	})
	t.Run("without_internal_telemetry", func(t *testing.T) {
		setObsConsumerGateForTest(t, false)
		testReloadAddNewConnectorBetweenExistingPipelines(t)
...
func TestReloadPipelineRemovalWithSharedReceiver(t *testing.T) {
	t.Run("with_internal_telemetry", func(t *testing.T) {
		setObsConsumerGateForTest(t, true)
		testReloadPipelineRemovalWithSharedReceiver(t)
	})
	t.Run("without_internal_telemetry", func(t *testing.T) {
		setObsConsumerGateForTest(t, false)
		testReloadPipelineRemovalWithSharedReceiver(t)
...
func TestReloadPipelineRemovalWithSharedExporter(t *testing.T) {
	t.Run("with_internal_telemetry", func(t *testing.T) {
		setObsConsumerGateForTest(t, true)
		testReloadPipelineRemovalWithSharedExporter(t)
	})
	t.Run("without_internal_telemetry", func(t *testing.T) {
		setObsConsumerGateForTest(t, false)
		testReloadPipelineRemovalWithSharedExporter(t)
