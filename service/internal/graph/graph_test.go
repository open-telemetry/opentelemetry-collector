...
func TestConnectorPipelinesGraph(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			pipelineConfigs: pipelines.Config{
				...
				component.NewPipelineIDWithName("traces", "1"): {
					Receivers: []component.ID{component.MustNewID("examplereceiver")},
					Exporters: []component.ID{component.MustNewID("exampleexporter")},
				},
				component.NewPipelineID("metrics"): {
				...
				component.NewPipelineIDWithName("metrics", "1"): {
					Receivers: []component.ID{component.MustNewID("examplereceiver")},
					Exporters: []component.ID{component.MustNewID("exampleexporter")},
				},
				component.NewPipelineID("logs"): {
				...
				component.NewPipelineIDWithName("logs", "1"): {
					Receivers: []component.ID{component.MustNewID("examplereceiver")},
					Exporters: []component.ID{component.MustNewID("exampleexporter")},
				},
				component.NewPipelineID("profiles"): {
				...
				component.NewPipelineIDWithName("profiles", "1"): {
					Receivers: []component.ID{component.MustNewID("examplereceiver")},
					Exporters: []component.ID{component.MustNewID("exampleexporter")},
				},
			},
		...
		},
		{
			...
			pipelineConfigs: pipelines.Config{
				component.NewPipelineIDWithName("traces", "in"): {
					Receivers:  []component.ID{component.MustNewID("examplereceiver")},
					Processors: []component.ID{component.MustNewID("exampleprocessor")},
					Exporters:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
				},
				component.NewPipelineIDWithName("traces", "out"): {
		...
		},
		{
			...
			pipelineConfigs: pipelines.Config{
				component.NewPipelineIDWithName("metrics", "in"): {
					Receivers:  []component.ID{component.MustNewID("examplereceiver")},
					Processors: []component.ID{component.MustNewID("exampleprocessor")},
					Exporters:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
				},
				component.NewPipelineIDWithName("metrics", "out"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
					Processors: []component.ID{component.MustNewIDWithName("exampleprocessor", "mutate")}, // mutate propagates upstream to connector
					Exporters:  []component.ID{component.MustNewID("exampleexporter")},
				},
		...
		},
		{
			...
			pipelineConfigs: pipelines.Config{
				component.NewPipelineIDWithName("logs", "in"): {
					Receivers:  []component.ID{component.MustNewID("examplereceiver")},
					Processors: []component.ID{component.MustNewID("exampleprocessor")},
					Exporters:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
				},
				component.NewPipelineIDWithName("logs", "out"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
					Processors: []component.ID{component.MustNewIDWithName("exampleprocessor", "mutate")}, // mutate propagates upstream to connector
					Exporters:  []component.ID{component.MustNewID("exampleexporter")},
				},
		...
		},
		{
			...
			pipelineConfigs: pipelines.Config{
				component.NewPipelineIDWithName("profiles", "in"): {
					Receivers:  []component.ID{component.MustNewID("examplereceiver")},
					Processors: []component.ID{component.MustNewID("exampleprocessor")},
					Exporters:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
				},
				component.NewPipelineIDWithName("profiles", "out"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
					Processors: []component.ID{component.MustNewIDWithName("exampleprocessor", "mutate")}, // mutate propagates upstream to connector
					Exporters:  []component.ID{component.MustNewID("exampleexporter")},
				},
		...
		},
		{
			...
			pipelineConfigs: pipelines.Config{
				...
				component.NewPipelineIDWithName("traces", "type0"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
					Processors: []component.ID{component.MustNewID("exampleprocessor")},
					Exporters:  []component.ID{component.MustNewIDWithName("exampleconnector", "merge")},
				},
				component.NewPipelineIDWithName("traces", "type1"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
					Processors: []component.ID{component.MustNewIDWithName("exampleprocessor", "mutate")}, // mutate propagates upstream to connector
					Exporters:  []component.ID{component.MustNewIDWithName("exampleconnector", "merge")},
				},
		...
		},
		{
			...
			pipelineConfigs: pipelines.Config{
				...
				component.NewPipelineIDWithName("metrics", "type0"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
					Processors: []component.ID{component.MustNewID("exampleprocessor")},
					Exporters:  []component.ID{component.MustNewIDWithName("exampleconnector", "merge")},
				},
				component.NewPipelineIDWithName("metrics", "type1"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
					Processors: []component.ID{component.MustNewIDWithName("exampleprocessor", "mutate")}, // mutate propagates upstream to connector
					Exporters:  []component.ID{component.MustNewIDWithName("exampleconnector", "merge")},
				},
		...
		},
		{
			...
			pipelineConfigs: pipelines.Config{
				...
				component.NewPipelineIDWithName("logs", "type0"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
					Processors: []component.ID{component.MustNewID("exampleprocessor")},
					Exporters:  []component.ID{component.MustNewIDWithName("exampleconnector", "merge")},
				},
				component.NewPipelineIDWithName("logs", "type1"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
					Processors: []component.ID{component.MustNewIDWithName("exampleprocessor", "mutate")}, // mutate propagates upstream to connector
					Exporters:  []component.ID{component.MustNewIDWithName("exampleconnector", "merge")},
				},
		...
		},
		{
			...
			pipelineConfigs: pipelines.Config{
				...
				component.NewPipelineIDWithName("profiles", "type0"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
					Processors: []component.ID{component.MustNewID("exampleprocessor")},
					Exporters:  []component.ID{component.MustNewIDWithName("exampleconnector", "merge")},
				},
				component.NewPipelineIDWithName("profiles", "type1"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
					Processors: []component.ID{component.MustNewIDWithName("exampleprocessor", "mutate")}, // mutate propagates upstream to connector
					Exporters:  []component.ID{component.MustNewIDWithName("exampleconnector", "merge")},
				},
		...
		},
		{
			...
			pipelineConfigs: pipelines.Config{
				...
				component.NewPipelineIDWithName("traces", "out0"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
					Processors: []component.ID{component.MustNewID("exampleprocessor")},
					Exporters:  []component.ID{component.MustNewID("exampleexporter")},
				},
				component.NewPipelineIDWithName("traces", "middle"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
					Processors: []component.ID{component.MustNewID("exampleprocessor")},
					Exporters:  []component.ID{component.MustNewIDWithName("exampleconnector", "mutate")},
				},
				component.NewPipelineIDWithName("traces", "out1"): {
		...
		},
		{
			...
			pipelineConfigs: pipelines.Config{
				...
				component.NewPipelineIDWithName("metrics", "out0"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
					Processors: []component.ID{component.MustNewID("exampleprocessor")},
					Exporters:  []component.ID{component.MustNewID("exampleexporter")},
				},
				component.NewPipelineIDWithName("metrics", "middle"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
					Processors: []component.ID{component.MustNewID("exampleprocessor")},
					Exporters:  []component.ID{component.MustNewIDWithName("exampleconnector", "mutate")},
				},
				component.NewPipelineIDWithName("metrics", "out1"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "mutate")},
					Processors: []component.ID{component.MustNewID("exampleprocessor")},
					Exporters:  []component.ID{component.MustNewID("exampleexporter")},
				},
		...
		},
		{
			...
			pipelineConfigs: pipelines.Config{
				...
				component.NewPipelineIDWithName("logs", "out0"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
					Processors: []component.ID{component.MustNewID("exampleprocessor")},
					Exporters:  []component.ID{component.MustNewID("exampleexporter")},
				},
				component.NewPipelineIDWithName("logs", "middle"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
					Processors: []component.ID{component.MustNewID("exampleprocessor")},
					Exporters:  []component.ID{component.MustNewIDWithName("exampleconnector", "mutate")},
				},
				component.NewPipelineIDWithName("logs", "out1"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "mutate")},
					Processors: []component.ID{component.MustNewID("exampleprocessor")},
					Exporters:  []component.ID{component.MustNewID("exampleexporter")},
				},
		...
		},
		{
			...
			pipelineConfigs: pipelines.Config{
				...
				component.NewPipelineIDWithName("profiles", "out0"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
					Processors: []component.ID{component.MustNewID("exampleprocessor")},
					Exporters:  []component.ID{component.MustNewID("exampleexporter")},
				},
				component.NewPipelineIDWithName("profiles", "middle"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "inherit_mutate")},
					Processors: []component.ID{component.MustNewID("exampleprocessor")},
					Exporters:  []component.ID{component.MustNewIDWithName("exampleconnector", "mutate")},
				},
				component.NewPipelineIDWithName("profiles", "out1"): {
					Receivers:  []component.ID{component.MustNewIDWithName("exampleconnector", "mutate")},
					Processors: []component.ID{component.MustNewID("exampleprocessor")},
					Exporters:  []component.ID{component.MustNewID("exampleexporter")},
				},
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			mutatingPipelines := make(map[component.PipelineID]bool, len(test.pipelineConfigs))
			...
			for _, c := range allReceivers[component.SignalTraces] {
			...
			for _, c := range allReceivers[component.SignalMetrics] {
			...
			for _, c := range allReceivers[component.SignalLogs] {
			...
			for _, e := range allExporters[component.SignalTraces] {
			...
			for _, e := range allExporters[component.SignalMetrics] {
			...
			for _, e := range allExporters[component.SignalLogs] {
...
func TestConnectorRouter(t *testing.T) {
	...
	tracesInID := component.NewPipelineIDWithName("traces", "in")
	tracesRightID := component.NewPipelineIDWithName("traces", "right")
	tracesLeftID := component.NewPipelineIDWithName("traces", "left")

	metricsInID := component.NewPipelineIDWithName("metrics", "in")
	metricsRightID := component.NewPipelineIDWithName("metrics", "right")
	metricsLeftID := component.NewPipelineIDWithName("metrics", "left")

	logsInID := component.NewPipelineIDWithName("logs", "in")
	logsRightID := component.NewPipelineIDWithName("logs", "right")
	logsLeftID := component.NewPipelineIDWithName("logs", "left")

	profilesInID := component.NewPipelineIDWithName("profiles", "in")
	profilesRightID := component.NewPipelineIDWithName("profiles", "right")
	profilesLeftID := component.NewPipelineIDWithName("profiles", "left")
	...
	tracesReceiver := allReceivers[component.SignalTraces][rcvrID].(*testcomponents.ExampleReceiver)
	tracesRight := allExporters[component.SignalTraces][expRightID].(*testcomponents.ExampleExporter)
	tracesLeft := allExporters[component.SignalTraces][expLeftID].(*testcomponents.ExampleExporter)
	...
	metricsReceiver := allReceivers[component.SignalMetrics][rcvrID].(*testcomponents.ExampleReceiver)
	metricsRight := allExporters[component.SignalMetrics][expRightID].(*testcomponents.ExampleExporter)
	metricsLeft := allExporters[component.SignalMetrics][expLeftID].(*testcomponents.ExampleExporter)
	...
	logsReceiver := allReceivers[component.SignalLogs][rcvrID].(*testcomponents.ExampleReceiver)
	logsRight := allExporters[component.SignalLogs][expRightID].(*testcomponents.ExampleExporter)
	logsLeft := allExporters[component.SignalLogs][expLeftID].(*testcomponents.ExampleExporter)
	...
	tests := []struct {
		...
		},
		{
			...
			pipelineCfgs: pipelines.Config{
				...
				component.NewPipelineIDWithName("traces", "2"): {
		...
		},
		{
			...
			pipelineCfgs: pipelines.Config{
				...
				component.NewPipelineIDWithName("metrics", "2"): {
					Receivers:  []component.ID{component.MustNewIDWithName("nop", "conn1")},
					Processors: []component.ID{component.MustNewID("nop")},
					Exporters:  []component.ID{component.MustNewIDWithName("nop", "conn2"), component.MustNewIDWithName("nop", "conn")},
				},
		...
		},
		{
			...
			pipelineCfgs: pipelines.Config{
				...
				component.NewPipelineIDWithName("logs", "2"): {
					Receivers:  []component.ID{component.MustNewIDWithName("nop", "conn1")},
					Processors: []component.ID{component.MustNewID("nop")},
					Exporters:  []component.ID{component.MustNewIDWithName("nop", "conn2"), component.MustNewIDWithName("nop", "conn")},
				},
		...
		},
		{
			...
			pipelineCfgs: pipelines.Config{
				...
				component.NewPipelineIDWithName("profiles", "2"): {
					Receivers:  []component.ID{component.MustNewIDWithName("nop", "conn1")},
					Processors: []component.ID{component.MustNewID("nop")},
					Exporters:  []component.ID{component.MustNewIDWithName("nop", "conn2"), component.MustNewIDWithName("nop", "conn")},
				},
...
func TestGraphFailToStartAndShutdown(t *testing.T) {
	...
	dataTypes := []component.Signal{component.SignalTraces, component.SignalMetrics, component.SignalLogs}
...
func (g *Graph) getReceivers() map[component.Signal]map[component.ID]component.Component {
	receiversMap := make(map[component.Signal]map[component.ID]component.Component)
	receiversMap[component.SignalTraces] = make(map[component.ID]component.Component)
	receiversMap[component.SignalMetrics] = make(map[component.ID]component.Component)
	receiversMap[component.SignalLogs] = make(map[component.ID]component.Component)
...
func expectedInstances(m pipelines.Config, pID component.PipelineID) (int, int) {
	...
	for _, rID := range m[pID].Receivers {
		...
		typeMap := map[component.Signal]bool{}
