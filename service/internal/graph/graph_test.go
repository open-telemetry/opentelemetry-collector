...
func newErrConnectorFactory() connector.Factory {
	return connector.NewFactory(component.MustNewType("err"), func() component.Config {
		...
		connector.WithTracesToTraces(func(context.Context, connector.CreateSettings, component.Config, ctrace.Traces) (connector.Traces, error) {
			return &errComponent{}, nil
		...
		connector.WithMetricsToTraces(func(context.Context, connector.CreateSettings, component.Config, ctrace.Traces) (connector.Metrics, error) {
			return &errComponent{}, nil
		}, component.StabilityLevelUnmaintained),
		...
		connector.WithLogsToTraces(func(context.Context, connector.CreateSettings, component.Config, ctrace.Traces) (connector.Logs, error) {
			return &errComponent{}, nil
		}, component.StabilityLevelUnmaintained),
