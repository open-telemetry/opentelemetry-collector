...
func newErrReceiverFactory() receiver.Factory {
	return receiverprofiles.NewFactory(component.MustNewType("err"),
		...
		receiverprofiles.WithProfiles(func(context.Context, receiver.Settings, component.Config, consumerexp.Profiles) (receiverprofiles.Profiles, error) {
			return &errComponent{}, nil
		}, component.StabilityLevelUndefined),
	)
}
...
func newErrProcessorFactory() processor.Factory {
	return processorprofiles.NewFactory(component.MustNewType("err"),
		...
		processorprofiles.WithProfiles(func(context.Context, processor.Settings, component.Config, consumerexp.Profiles) (processorprofiles.Profiles, error) {
			return &errComponent{}, nil
		}, component.StabilityLevelUndefined),
	)
}
...
func newErrConnectorFactory() connector.Factory {
	return connectorprofiles.NewFactory(component.MustNewType("err"), func() component.Config {
		...
		connectorprofiles.WithTracesToProfiles(func(context.Context, connector.Settings, component.Config, consumerexp.Profiles) (connector.Traces, error) {
			return &errComponent{}, nil
		}, component.StabilityLevelUnmaintained),
		...
		connectorprofiles.WithMetricsToProfiles(func(context.Context, connector.Settings, component.Config, consumerexp.Profiles) (connector.Metrics, error) {
			return &errComponent{}, nil
		}, component.StabilityLevelUnmaintained),
		...
		connectorprofiles.WithLogsToProfiles(func(context.Context, connector.Settings, component.Config, consumerexp.Profiles) (connector.Logs, error) {
			return &errComponent{}, nil
		}, component.StabilityLevelUnmaintained),
		...
		connectorprofiles.WithProfilesToProfiles(func(context.Context, connector.Settings, component.Config, consumerexp.Profiles) (connectorprofiles.Profiles, error) {
			return &errComponent{}, nil
		}, component.StabilityLevelUnmaintained),
	)
}
