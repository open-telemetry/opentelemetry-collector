...
// ConsumeTraces exports the traces.Traces to all consumers wrapped by the current one.
func (tsc *tracesConsumer) ConsumeTraces(ctx context.Context, td traces.Traces) error {
	var errs error
