...
// ConsumeMetrics exports the metrics.Metrics to all consumers wrapped by the current one.
func (msc *metricsConsumer) ConsumeMetrics(ctx context.Context, md metrics.Metrics) error {
	var errs error
