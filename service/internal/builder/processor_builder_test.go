...
func createRldTracesProcessor(_ context.Context, _ component.ProcessorCreateParams, _ config.Processor, nextConsumer consumer.Traces) (component.TracesProcessor, error) {
	return &rldExampleProcessor{exampleProcessor: exampleProcessor{Traces: nextConsumer}}, nil
}

func createRldMetricsProcessor(_ context.Context, _ component.ProcessorCreateParams, _ config.Processor, nextConsumer consumer.Metrics) (component.MetricsProcessor, error) {
	return &rldExampleProcessor{exampleProcessor: exampleProcessor{Metrics: nextConsumer}}, nil
}

func createRldLogsProcessor(_ context.Context, _ component.ProcessorCreateParams, _ config.Processor, nextConsumer consumer.Logs) (component.LogsProcessor, error) {
...
func TestProcessorsReload(t *testing.T) {
	...
	cfg, err := configtest.LoadConfigFile(t, "testdata/reload_pipelines_builder.yaml", factories)
	// Load the config
	require.Nil(t, err)
