...
func createExampleTracesToProfiles(_ context.Context, set connector.Settings, _ component.Config, profiles consumerexp.Profiles) (connector.Traces, error) {
	return &ExampleConnector{
		ConsumeTracesFunc: func(ctx context.Context, td ptrace.Traces) error {
...
func createExampleMetricsToProfiles(_ context.Context, set connector.Settings, _ component.Config, profiles consumerexp.Profiles) (connector.Metrics, error) {
	return &ExampleConnector{
		ConsumeMetricsFunc: func(ctx context.Context, md pmetric.Metrics) error {
...
func createExampleLogsToProfiles(_ context.Context, set connector.Settings, _ component.Config, profiles consumerexp.Profiles) (connector.Logs, error) {
	return &ExampleConnector{
		ConsumeLogsFunc: func(ctx context.Context, ld plog.Logs) error {
...
func createExampleProfilesToProfiles(_ context.Context, set connector.Settings, _ component.Config, profiles consumerexp.Profiles) (connectorprofiles.Profiles, error) {
	return &ExampleConnector{
