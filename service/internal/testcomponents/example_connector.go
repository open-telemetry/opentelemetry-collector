...
func createExampleTracesToTraces(_ context.Context, set connector.CreateSettings, _ component.Config, traces ctrace.Traces) (connector.Traces, error) {
...
func createExampleTracesToMetrics(_ context.Context, set connector.CreateSettings, _ component.Config, metrics cmetric.Metrics) (connector.Traces, error) {
	return &ExampleConnector{
...
func createExampleMetricsToTraces(_ context.Context, set connector.CreateSettings, _ component.Config, traces ctrace.Traces) (connector.Metrics, error) {
	return &ExampleConnector{
...
func createExampleMetricsToMetrics(_ context.Context, set connector.CreateSettings, _ component.Config, metrics cmetric.Metrics) (connector.Metrics, error) {
	return &ExampleConnector{
...
func createExampleLogsToTraces(_ context.Context, set connector.CreateSettings, _ component.Config, traces ctrace.Traces) (connector.Logs, error) {
	return &ExampleConnector{
...
func createExampleLogsToMetrics(_ context.Context, set connector.CreateSettings, _ component.Config, metrics cmetric.Metrics) (connector.Logs, error) {
	return &ExampleConnector{
		ConsumeLogsFunc: func(ctx context.Context, ld plog.Logs) error {
