...
func TestTracesRouter(t *testing.T) {
	...
	sinkLeft := new(ctracetest.TracesSink)
	sinkRight := new(ctracetest.TracesSink)
	...
	router := connector.NewTracesRouter(
		map[component.ID]ctrace.Traces{
			leftID:  sinkLeft,
			rightID: sinkRight,
		})
...
func TestMetricsRouter(t *testing.T) {
	...
	sinkLeft := new(cmetrictest.MetricsSink)
	sinkRight := new(cmetrictest.MetricsSink)
	...
	router := connector.NewMetricsRouter(
		map[component.ID]cmetric.Metrics{
			leftID:  sinkLeft,
			rightID: sinkRight,
		})
...
func TestLogsRouter(t *testing.T) {
	...
	sinkLeft := new(conslogtest.LogsSink)
	sinkRight := new(conslogtest.LogsSink)
