...
func (bes *Extensions) GetExtensions() map[component.ID]extension.Extension {
	result := make(map[component.ID]extension.Extension, len(bes.extMap))
...
type Settings struct {
	...
	Configs map[component.ID]extension.Config

	// Factories maps extension type names in the config to the respective component.Factory.
