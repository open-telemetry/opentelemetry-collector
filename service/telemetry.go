...
const (
	...
	// allowContextPropagationFeatureGateID is the feature gate ID that rt to propagate traceparent etc.
	// headers from collector to the downstream entities that process the export requests from collector
...
func newColTelemetry(registry *featuregate.Registry) *telemetryInitializer {
	...
	registry.MustRegister(featuregate.Gate{
		...
		Description: "controls whether to propagate trace context headers of the internal spans generated by collector",
		Enabled:     false,
	})
