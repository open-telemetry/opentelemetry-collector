...
require (
	...
	go.opentelemetry.io/collector/internal/fanoutconsumer v0.141.0
	go.opentelemetry.io/collector/internal/telemetry v0.141.0
	...
	go.opentelemetry.io/collector/service/telemetry/telemetrytest v0.141.0
