...
func TestConfigValidate(t *testing.T) {
	var testCases = []struct {
		...
		},
		{
			...
			cfgFn: func() *Config {
				cfg := generateConfig()
				cfg.Service.Extensions = append(cfg.Service.Extensions, component.NewIDWithName(component.MustType("nop"), "2"))
				return cfg
			},
		...
		},
		{
			...
			cfgFn: func() *Config {
				cfg := generateConfig()
				pipe := cfg.Service.Pipelines[component.NewID(component.MustType("traces"))]
				pipe.Receivers = append(pipe.Receivers, component.NewIDWithName(component.MustType("nop"), "2"))
				return cfg
			},
		...
		},
		{
			...
			cfgFn: func() *Config {
				cfg := generateConfig()
				pipe := cfg.Service.Pipelines[component.NewID(component.MustType("traces"))]
				pipe.Processors = append(pipe.Processors, component.NewIDWithName(component.MustType("nop"), "2"))
				return cfg
			},
		...
		},
		{
			...
			cfgFn: func() *Config {
				cfg := generateConfig()
				pipe := cfg.Service.Pipelines[component.NewID(component.MustType("traces"))]
				pipe.Exporters = append(pipe.Exporters, component.NewIDWithName(component.MustType("nop"), "2"))
				return cfg
			},
		...
		},
		{
			...
			cfgFn: func() *Config {
				cfg := generateConfig()
				cfg.Receivers[component.NewID(component.MustType("nop"))] = &errConfig{
		...
		},
		{
			...
			cfgFn: func() *Config {
				cfg := generateConfig()
				cfg.Exporters[component.NewID(component.MustType("nop"))] = &errConfig{
		...
		},
		{
			...
			cfgFn: func() *Config {
				cfg := generateConfig()
				cfg.Processors[component.NewID(component.MustType("nop"))] = &errConfig{
		...
		},
		{
			...
			cfgFn: func() *Config {
				cfg := generateConfig()
				cfg.Extensions[component.NewID(component.MustType("nop"))] = &errConfig{
		...
		},
		{
			...
			cfgFn: func() *Config {
				cfg := generateConfig()
				cfg.Connectors[component.NewIDWithName(component.MustType("nop"), "conn")] = &errConfig{
		...
		},
		{
			...
			cfgFn: func() *Config {
				cfg := generateConfig()
				cfg.Receivers[component.NewID(component.MustType("nop2"))] = &errConfig{}
				cfg.Connectors[component.NewID(component.MustType("nop2"))] = &errConfig{}
				pipe := cfg.Service.Pipelines[component.NewID(component.MustType("traces"))]
				pipe.Receivers = append(pipe.Receivers, component.NewIDWithName(component.MustType("nop"), "2"))
				pipe.Exporters = append(pipe.Exporters, component.NewIDWithName(component.MustType("nop"), "2"))
				return cfg
		...
		},
		{
			...
			cfgFn: func() *Config {
				cfg := generateConfig()
				cfg.Exporters[component.NewID(component.MustType("nop2"))] = &errConfig{}
				cfg.Connectors[component.NewID(component.MustType("nop2"))] = &errConfig{}
				pipe := cfg.Service.Pipelines[component.NewID(component.MustType("traces"))]
				pipe.Receivers = append(pipe.Receivers, component.NewIDWithName(component.MustType("nop"), "2"))
				pipe.Exporters = append(pipe.Exporters, component.NewIDWithName(component.MustType("nop"), "2"))
		...
		},
		{
			...
			cfgFn: func() *Config {
				cfg := generateConfig()
				pipe := cfg.Service.Pipelines[component.NewID(component.MustType("traces"))]
				pipe.Receivers = append(pipe.Receivers, component.NewIDWithName(component.MustType("nop"), "conn2"))
				return cfg
			},
		...
		},
		{
			...
			cfgFn: func() *Config {
				cfg := generateConfig()
				pipe := cfg.Service.Pipelines[component.NewID(component.MustType("traces"))]
				pipe.Exporters = append(pipe.Exporters, component.NewIDWithName(component.MustType("nop"), "conn2"))
				return cfg
			},
...
func generateConfig() *Config {
	return &Config{
		Receivers: map[component.ID]component.Config{
			component.NewID(component.MustType("nop")): &errConfig{},
		},
		...
		Connectors: map[component.ID]component.Config{
			component.NewIDWithName(component.MustType("nop"), "conn"): &errConfig{},
		},
		...
		Service: service.Config{
			...
			Extensions: []component.ID{component.NewID(component.MustType("nop"))},
