	...
	provider, err := otelcol.NewConfigProvider(otelcol.ConfigProviderSettings{
		ResolverSettings: confmap.ResolverSettings{
			...
			Providers: makeMapProvidersMap(
				fileprovider.NewWithSettings(confmap.NewProviderSettingsNoopLogger()),
				envprovider.NewWithSettings(confmap.NewProviderSettingsNoopLogger()),
				yamlprovider.NewWithSettings(confmap.NewProviderSettingsNoopLogger()),
				httpprovider.NewWithSettings(confmap.NewProviderSettingsNoopLogger()),
			),
