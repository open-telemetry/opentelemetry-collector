...
// 	cmd := newConfigPrintSubCommand(set, flags(featuregate.GlobalRegistry()))
...
// func TestConfigPrintCommandWithSensitiveData(t *testing.T) {
...
// func TestConfigPrintCommandUnredactedMode(t *testing.T) {
