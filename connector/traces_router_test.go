...
func fuzzTraces(numIDs, numCons, numTraces int) func(*testing.T) {
	return func(t *testing.T) {
		...
		allCons := make([]consumertraces.Traces, 0, numCons)
		allConsMap := make(map[component.ID]consumertraces.Traces)
...
func TestTracesRouterConsumer(t *testing.T) {
	...
	r := NewTracesRouter(map[component.ID]consumertraces.Traces{fooID: foo, barID: bar})
