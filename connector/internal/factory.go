...
func (f CreateTracesToTracesFunc) CreateTracesToTraces(
	...
	if f == nil {
		return nil, ErrDataTypes(set.ID, component.SignalTraces, component.SignalTraces)
	}
...
func (f CreateTracesToMetricsFunc) CreateTracesToMetrics(
	...
	if f == nil {
		return nil, ErrDataTypes(set.ID, component.SignalTraces, component.SignalMetrics)
	}
	return f(ctx, set, cfg, nextConsumer)
}
...
func (f CreateTracesToLogsFunc) CreateTracesToLogs(
	...
	if f == nil {
		return nil, ErrDataTypes(set.ID, component.SignalTraces, component.SignalLogs)
	}
	return f(ctx, set, cfg, nextConsumer)
}
...
func (f CreateTracesToProfilesFunc) CreateTracesToProfiles(
	...
	if f == nil {
		return nil, ErrDataTypes(set.ID, component.SignalTraces, componentprofiles.SignalProfiles)
	}
	return f(ctx, set, cfg, nextConsumer)
}
...
func (f CreateMetricsToTracesFunc) CreateMetricsToTraces(
	...
	if f == nil {
		return nil, ErrDataTypes(set.ID, component.SignalMetrics, component.SignalTraces)
	}
	return f(ctx, set, cfg, nextConsumer)
}
...
func (f CreateMetricsToMetricsFunc) CreateMetricsToMetrics(
	...
	if f == nil {
		return nil, ErrDataTypes(set.ID, component.SignalMetrics, component.SignalMetrics)
	}
	return f(ctx, set, cfg, nextConsumer)
}
...
func (f CreateMetricsToLogsFunc) CreateMetricsToLogs(
	...
	if f == nil {
		return nil, ErrDataTypes(set.ID, component.SignalMetrics, component.SignalLogs)
	}
	return f(ctx, set, cfg, nextConsumer)
}
...
func (f CreateMetricsToProfilesFunc) CreateMetricsToProfiles(
	...
	if f == nil {
		return nil, ErrDataTypes(set.ID, component.SignalMetrics, componentprofiles.SignalProfiles)
	}
	return f(ctx, set, cfg, nextConsumer)
}
...
func (f CreateLogsToTracesFunc) CreateLogsToTraces(
	...
	if f == nil {
		return nil, ErrDataTypes(set.ID, component.SignalLogs, component.SignalTraces)
	}
	return f(ctx, set, cfg, nextConsumer)
}
...
func (f CreateLogsToMetricsFunc) CreateLogsToMetrics(
	...
	if f == nil {
		return nil, ErrDataTypes(set.ID, component.SignalLogs, component.SignalMetrics)
	}
	return f(ctx, set, cfg, nextConsumer)
}
...
func (f CreateLogsToLogsFunc) CreateLogsToLogs(
	...
	if f == nil {
		return nil, ErrDataTypes(set.ID, component.SignalLogs, component.SignalLogs)
	}
	return f(ctx, set, cfg, nextConsumer)
}
...
func (f CreateLogsToProfilesFunc) CreateLogsToProfiles(
	...
	if f == nil {
		return nil, ErrDataTypes(set.ID, component.SignalLogs, componentprofiles.SignalProfiles)
	}
	return f(ctx, set, cfg, nextConsumer)
}
...
func (f CreateProfilesToTracesFunc) CreateProfilesToTraces(
	...
	if f == nil {
		return nil, ErrDataTypes(set.ID, componentprofiles.SignalProfiles, component.SignalTraces)
	}
	return f(ctx, set, cfg, nextConsumer)
}
...
func (f CreateProfilesToMetricsFunc) CreateProfilesToMetrics(
	...
	if f == nil {
		return nil, ErrDataTypes(set.ID, componentprofiles.SignalProfiles, component.SignalMetrics)
	}
	return f(ctx, set, cfg, nextConsumer)
}
...
func (f CreateProfilesToLogsFunc) CreateProfilesToLogs(
	...
	if f == nil {
		return nil, ErrDataTypes(set.ID, componentprofiles.SignalProfiles, component.SignalLogs)
	}
	return f(ctx, set, cfg, nextConsumer)
}
...
func ErrDataTypes(id component.ID, from, to component.Signal) error {
