...
func TestComponentLifecycle(t *testing.T) {
	...
	tests := []struct {
...

		{
			name: "logs_to_logs",
			createFn: func(ctx context.Context, set connector.CreateSettings, cfg component.Config) (component.Component, error) {
				router := connector.NewLogsRouter(map[component.ID]consumerlogs.Logs{component.NewID(component.DataTypeLogs): consumertest.NewNop()})
...

		{
			...
			createFn: func(ctx context.Context, set connector.CreateSettings, cfg component.Config) (component.Component, error) {
				router := connector.NewMetricsRouter(map[component.ID]consumermetrics.Metrics{component.NewID(component.DataTypeMetrics): consumertest.NewNop()})
...

		{
			...
			createFn: func(ctx context.Context, set connector.CreateSettings, cfg component.Config) (component.Component, error) {
				router := connector.NewTracesRouter(map[component.ID]consumertraces.Traces{component.NewID(component.DataTypeTraces): consumertest.NewNop()})
