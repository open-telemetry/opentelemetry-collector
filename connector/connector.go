...
// Traces feeds a consumertraces.Traces, consumermetrics.Metrics, or consumerlogs.Logs with data.
//
// Examples:
...
// to one or more traces, metrics, or logs pipelines.
// Metrics feeds a consumertraces.Traces, consumermetrics.Metrics, or consumerlogs.Logs with data.
//
// Examples:
...
// to one or more traces, metrics, or logs pipelines.
// Logs feeds a consumertraces.Traces, consumermetrics.Metrics, or consumerlogs.Logs with data.
//
// Examples:
...
type Factory interface {
	...
	CreateTracesToTraces(ctx context.Context, set CreateSettings, cfg component.Config, nextConsumer consumertraces.Traces) (Traces, error)
	CreateTracesToMetrics(ctx context.Context, set CreateSettings, cfg component.Config, nextConsumer consumermetrics.Metrics) (Traces, error)
	CreateTracesToLogs(ctx context.Context, set CreateSettings, cfg component.Config, nextConsumer consumerlogs.Logs) (Traces, error)

	CreateMetricsToTraces(ctx context.Context, set CreateSettings, cfg component.Config, nextConsumer consumertraces.Traces) (Metrics, error)
	CreateMetricsToMetrics(ctx context.Context, set CreateSettings, cfg component.Config, nextConsumer consumermetrics.Metrics) (Metrics, error)
	CreateMetricsToLogs(ctx context.Context, set CreateSettings, cfg component.Config, nextConsumer consumerlogs.Logs) (Metrics, error)

	CreateLogsToTraces(ctx context.Context, set CreateSettings, cfg component.Config, nextConsumer consumertraces.Traces) (Logs, error)
	CreateLogsToMetrics(ctx context.Context, set CreateSettings, cfg component.Config, nextConsumer consumermetrics.Metrics) (Logs, error)
	CreateLogsToLogs(ctx context.Context, set CreateSettings, cfg component.Config, nextConsumer consumerlogs.Logs) (Logs, error)
...
type CreateTracesToTracesFunc func(context.Context, CreateSettings, component.Config, consumertraces.Traces) (Traces, error)
...
func (f CreateTracesToTracesFunc) CreateTracesToTraces(
	...
	nextConsumer consumertraces.Traces) (Traces, error) {
	if f == nil {
...
type CreateTracesToMetricsFunc func(context.Context, CreateSettings, component.Config, consumermetrics.Metrics) (Traces, error)
...
type CreateTracesToLogsFunc func(context.Context, CreateSettings, component.Config, consumerlogs.Logs) (Traces, error)
...
type CreateMetricsToTracesFunc func(context.Context, CreateSettings, component.Config, consumertraces.Traces) (Metrics, error)
...
type CreateMetricsToMetricsFunc func(context.Context, CreateSettings, component.Config, consumermetrics.Metrics) (Metrics, error)
...
type CreateMetricsToLogsFunc func(context.Context, CreateSettings, component.Config, consumerlogs.Logs) (Metrics, error)
...
type CreateLogsToTracesFunc func(context.Context, CreateSettings, component.Config, consumertraces.Traces) (Logs, error)
...
type CreateLogsToMetricsFunc func(context.Context, CreateSettings, component.Config, consumermetrics.Metrics) (Logs, error)
...
type CreateLogsToLogsFunc func(context.Context, CreateSettings, component.Config, consumerlogs.Logs) (Logs, error)
...
func (b *Builder) CreateTracesToTraces(ctx context.Context, set CreateSettings, next consumertraces.Traces) (Traces, error) {
	if next == nil {
...
func (b *Builder) CreateTracesToMetrics(ctx context.Context, set CreateSettings, next consumermetrics.Metrics) (Traces, error) {
	if next == nil {
		return nil, errNilNextConsumer
	}
	cfg, existsCfg := b.cfgs[set.ID]
...
func (b *Builder) CreateTracesToLogs(ctx context.Context, set CreateSettings, next consumerlogs.Logs) (Traces, error) {
	if next == nil {
		return nil, errNilNextConsumer
	}
	cfg, existsCfg := b.cfgs[set.ID]
...
func (b *Builder) CreateMetricsToTraces(ctx context.Context, set CreateSettings, next consumertraces.Traces) (Metrics, error) {
	if next == nil {
		return nil, errNilNextConsumer
	}
	cfg, existsCfg := b.cfgs[set.ID]
...
func (b *Builder) CreateMetricsToMetrics(ctx context.Context, set CreateSettings, next consumermetrics.Metrics) (Metrics, error) {
	if next == nil {
		return nil, errNilNextConsumer
	}
	cfg, existsCfg := b.cfgs[set.ID]
...
func (b *Builder) CreateMetricsToLogs(ctx context.Context, set CreateSettings, next consumerlogs.Logs) (Metrics, error) {
	if next == nil {
		return nil, errNilNextConsumer
	}
	cfg, existsCfg := b.cfgs[set.ID]
...
func (b *Builder) CreateLogsToTraces(ctx context.Context, set CreateSettings, next consumertraces.Traces) (Logs, error) {
	if next == nil {
		return nil, errNilNextConsumer
	}
	cfg, existsCfg := b.cfgs[set.ID]
...
func (b *Builder) CreateLogsToMetrics(ctx context.Context, set CreateSettings, next consumermetrics.Metrics) (Logs, error) {
	if next == nil {
		return nil, errNilNextConsumer
	}
	cfg, existsCfg := b.cfgs[set.ID]
...
func (b *Builder) CreateLogsToLogs(ctx context.Context, set CreateSettings, next consumerlogs.Logs) (Logs, error) {
	if next == nil {
		return nil, errNilNextConsumer
	}
	cfg, existsCfg := b.cfgs[set.ID]
