...
type CreateSettings = component.Settings
...
type Factory interface {
	...
	CreateTracesToTraces(ctx context.Context, set component.Settings, cfg component.Config, nextConsumer consumer.Traces) (Traces, error)
	CreateTracesToMetrics(ctx context.Context, set component.Settings, cfg component.Config, nextConsumer consumer.Metrics) (Traces, error)
	CreateTracesToLogs(ctx context.Context, set component.Settings, cfg component.Config, nextConsumer consumer.Logs) (Traces, error)

	CreateMetricsToTraces(ctx context.Context, set component.Settings, cfg component.Config, nextConsumer consumer.Traces) (Metrics, error)
	CreateMetricsToMetrics(ctx context.Context, set component.Settings, cfg component.Config, nextConsumer consumer.Metrics) (Metrics, error)
	CreateMetricsToLogs(ctx context.Context, set component.Settings, cfg component.Config, nextConsumer consumer.Logs) (Metrics, error)

	CreateLogsToTraces(ctx context.Context, set component.Settings, cfg component.Config, nextConsumer consumer.Traces) (Logs, error)
	CreateLogsToMetrics(ctx context.Context, set component.Settings, cfg component.Config, nextConsumer consumer.Metrics) (Logs, error)
	CreateLogsToLogs(ctx context.Context, set component.Settings, cfg component.Config, nextConsumer consumer.Logs) (Logs, error)
...
type CreateTracesToTracesFunc func(context.Context, component.Settings, component.Config, consumer.Traces) (Traces, error)
...
type CreateTracesToMetricsFunc func(context.Context, component.Settings, component.Config, consumer.Metrics) (Traces, error)
...
type CreateTracesToLogsFunc func(context.Context, component.Settings, component.Config, consumer.Logs) (Traces, error)
...
type CreateMetricsToTracesFunc func(context.Context, component.Settings, component.Config, consumer.Traces) (Metrics, error)
...
type CreateMetricsToMetricsFunc func(context.Context, component.Settings, component.Config, consumer.Metrics) (Metrics, error)
...
type CreateMetricsToLogsFunc func(context.Context, component.Settings, component.Config, consumer.Logs) (Metrics, error)
...
type CreateLogsToTracesFunc func(context.Context, component.Settings, component.Config, consumer.Traces) (Logs, error)
...
type CreateLogsToMetricsFunc func(context.Context, component.Settings, component.Config, consumer.Metrics) (Logs, error)
...
type CreateLogsToLogsFunc func(context.Context, component.Settings, component.Config, consumer.Logs) (Logs, error)
...
func (b *Builder) CreateTracesToTraces(ctx context.Context, set component.Settings, next consumer.Traces) (Traces, error) {
	if next == nil {
...
func (b *Builder) CreateTracesToMetrics(ctx context.Context, set component.Settings, next consumer.Metrics) (Traces, error) {
	if next == nil {
		return nil, errNilNextConsumer
	}
	cfg, existsCfg := b.cfgs[set.ID]
...
func (b *Builder) CreateTracesToLogs(ctx context.Context, set component.Settings, next consumer.Logs) (Traces, error) {
	if next == nil {
		return nil, errNilNextConsumer
	}
	cfg, existsCfg := b.cfgs[set.ID]
...
func (b *Builder) CreateMetricsToTraces(ctx context.Context, set component.Settings, next consumer.Traces) (Metrics, error) {
	if next == nil {
		return nil, errNilNextConsumer
	}
	cfg, existsCfg := b.cfgs[set.ID]
...
func (b *Builder) CreateMetricsToMetrics(ctx context.Context, set component.Settings, next consumer.Metrics) (Metrics, error) {
	if next == nil {
		return nil, errNilNextConsumer
	}
	cfg, existsCfg := b.cfgs[set.ID]
...
func (b *Builder) CreateMetricsToLogs(ctx context.Context, set component.Settings, next consumer.Logs) (Metrics, error) {
	if next == nil {
		return nil, errNilNextConsumer
	}
	cfg, existsCfg := b.cfgs[set.ID]
...
func (b *Builder) CreateLogsToTraces(ctx context.Context, set component.Settings, next consumer.Traces) (Logs, error) {
	if next == nil {
		return nil, errNilNextConsumer
	}
	cfg, existsCfg := b.cfgs[set.ID]
...
func (b *Builder) CreateLogsToMetrics(ctx context.Context, set component.Settings, next consumer.Metrics) (Logs, error) {
	if next == nil {
		return nil, errNilNextConsumer
	}
	cfg, existsCfg := b.cfgs[set.ID]
...
func (b *Builder) CreateLogsToLogs(ctx context.Context, set component.Settings, next consumer.Logs) (Logs, error) {
	if next == nil {
		return nil, errNilNextConsumer
	}
	cfg, existsCfg := b.cfgs[set.ID]
