...
func TestNewNopConnectorFactory(t *testing.T) {
	...
	tracesToTraces, err := factory.CreateTracesToTraces(context.Background(), componenttest.NewNopSettings(), cfg, consumertest.NewNop())
	...
	tracesToMetrics, err := factory.CreateTracesToMetrics(context.Background(), componenttest.NewNopSettings(), cfg, consumertest.NewNop())
	require.NoError(t, err)
	...
	tracesToLogs, err := factory.CreateTracesToLogs(context.Background(), componenttest.NewNopSettings(), cfg, consumertest.NewNop())
	require.NoError(t, err)
	...
	metricsToTraces, err := factory.CreateMetricsToTraces(context.Background(), componenttest.NewNopSettings(), cfg, consumertest.NewNop())
	require.NoError(t, err)
	...
	metricsToMetrics, err := factory.CreateMetricsToMetrics(context.Background(), componenttest.NewNopSettings(), cfg, consumertest.NewNop())
	require.NoError(t, err)
	...
	metricsToLogs, err := factory.CreateMetricsToLogs(context.Background(), componenttest.NewNopSettings(), cfg, consumertest.NewNop())
	require.NoError(t, err)
	...
	logsToTraces, err := factory.CreateLogsToTraces(context.Background(), componenttest.NewNopSettings(), cfg, consumertest.NewNop())
	require.NoError(t, err)
	...
	logsToMetrics, err := factory.CreateLogsToMetrics(context.Background(), componenttest.NewNopSettings(), cfg, consumertest.NewNop())
	require.NoError(t, err)
	...
	logsToLogs, err := factory.CreateLogsToLogs(context.Background(), componenttest.NewNopSettings(), cfg, consumertest.NewNop())
	require.NoError(t, err)
