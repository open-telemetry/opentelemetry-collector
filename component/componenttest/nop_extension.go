...
// NewNopExtensionCreateSettings returns a new nop component.ExtensionCreateSettings.
...
// NewTestExtensionCreateSettings returns a new test component.ExtensionCreateSettings.
func NewTestExtensionCreateSettings(t *testing.T) component.ExtensionCreateSettings {
	return component.ExtensionCreateSettings{
		Logger: zaptest.NewLogger(t),
		// TODO: Create TracerProvider with exporter to testing.T.
		TracerProvider: trace.NewNoopTracerProvider(),
		BuildInfo:      component.DefaultBuildInfo(),
	}
}
