...
func (nh *nopHost) ReportStatus(event *component.StatusEvent) {
}

func (nh *nopHost) RegisterStatusListener(options ...component.StatusListenerOption) component.StatusUnregisterFunc {
	return nil
}
